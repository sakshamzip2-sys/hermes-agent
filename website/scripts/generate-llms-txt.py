#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the OpenComputer docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use OpenComputer as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with OpenComputer", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with OpenComputer", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with OpenComputer", None),
        ("guides/build-a-hermes-plugin", "Build a OpenComputer Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with OpenComputer"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# OpenComputer — Full Documentation\n",
        (
            "This file is the entire OpenComputer documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using OpenComputer, Features, Messaging, Integrations, Guides, "
