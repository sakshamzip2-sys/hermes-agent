...
```bash
python3 -m pyfiglet "OPENCOMPUTER" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=OPENCOMPUTER&font=Slant" | boxes -d stone
```
