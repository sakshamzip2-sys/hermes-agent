...
sidebar_position: 2
title: "添加工具"
description: "如何向 OpenComputer 添加新工具——schema、handler、注册与 toolset"
---
...
:::warning 仅限内置核心工具
本页面用于向仓库本身添加 **OpenComputer 内置工具**。
如果你想要个人专用、项目本地或其他自定义工具，而不修改 OpenComputer 核心，请使用插件方式：

- [插件](/user-guide/features/plugins)
- [构建 OpenComputer 插件](/guides/build-a-opencomputer-plugin)
...
- [ ] 已通过 `opencomputer chat -q "Use the weather tool for London"` 测试