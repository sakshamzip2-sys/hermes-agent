---
sidebar_position: 8
title: "Use Voice Mode with OpenComputer"
description: "A practical guide to setting up and using OpenComputer voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with OpenComputer
...
- you want OpenComputer sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in OpenComputer.
...
## Step 1: make sure normal OpenComputer works first
...
OpenComputer supports both local and cloud speech stacks.
...
4. OpenComputer transcribes and responds
...
- asking OpenComputer to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full OpenComputer loop.

## Tuning CLI behavior

### Silence threshold

If OpenComputer starts/stops too aggressively, tune:
...
OpenComputer stays a normal chat bot, but can speak replies.
...
- you want OpenComputer to function like a portable research or ops assistant
...
OpenComputer joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- OpenComputer detects speech boundaries
- transcripts are posted in the associated text channel
- OpenComputer responds in text and audio
...
1. get text OpenComputer working
