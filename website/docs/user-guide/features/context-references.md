...
Type `@` followed by a reference to inject content directly into your message. OpenComputer expands the reference inline and appends the content under an `--- Attached Context ---` section.
...
- OpenComputer env: `$HERMES_HOME/.env`
