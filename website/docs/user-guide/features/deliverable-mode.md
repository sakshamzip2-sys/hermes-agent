...
When OpenComputer runs inside a messaging gateway (Slack, Discord, Telegram,
...
If you use OpenComputer' kanban multi-agent workflow, workers can attach
...
back into the thread as a native attachment. OpenComputer's deliverable
