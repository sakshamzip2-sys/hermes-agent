...
| | |
|---|---|
| Source | Optional — install with `opencomputer skills install official/productivity/canvas` |
...
4. Name the token (e.g., "OpenComputer"), set an optional expiry, and click **Generate Token**
