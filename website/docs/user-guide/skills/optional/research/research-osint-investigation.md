...
| | |
|---|---|
| Source | Optional — install with `opencomputer skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | OpenComputer (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $HERMES_OSINT_CACHE/icij/ (default: ~/.cache/opencomputer-osint/icij/).
