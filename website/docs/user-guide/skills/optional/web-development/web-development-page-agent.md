...
- User wants **OpenComputer itself to drive a browser** → use OpenComputer' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
