...
| | |
|---|---|
| Source | Optional — install with `opencomputer skills install official/health/neuroskill-bci` |
...
Connect OpenComputer to a running [NeuroSkill](https://neuroskill.com/) instance to read
