...
## OpenComputer Integration Notes
...
To reply non-interactively from OpenComputer, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from OpenComputer)** — pipe the message via stdin:
