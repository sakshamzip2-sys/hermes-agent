---
title: "Kw Legal Vendor Check"
sidebar_label: "Kw Legal Vendor Check"
description: "Check the status of existing agreements with a vendor across all connected systems - CLM, CRM, email, and document storage - with gap analysis and upcoming d..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Legal Vendor Check
...
| Path | `skills/knowledge-work/legal/skills/vendor-check` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/legal/skills/vendor-check/../../CONNECTORS.md).
