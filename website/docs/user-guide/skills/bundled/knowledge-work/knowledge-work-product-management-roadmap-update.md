---
title: "Kw Product Management Roadmap Update — Update, create, or reprioritize your product roadmap"
sidebar_label: "Kw Product Management Roadmap Update"
description: "Update, create, or reprioritize your product roadmap"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Product Management Roadmap Update
...
| Path | `skills/knowledge-work/product-management/skills/roadmap-update` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/product-management/skills/roadmap-update/../../CONNECTORS.md).
