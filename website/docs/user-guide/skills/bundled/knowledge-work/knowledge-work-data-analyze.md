---
title: "Kw Data Analyze — Answer data questions -- from quick lookups to full analyses"
sidebar_label: "Kw Data Analyze"
...
| Path | `skills/knowledge-work/data/skills/analyze` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/data/skills/analyze/../../CONNECTORS.md).
