---
title: "Kw Operations Vendor Review — Evaluate a vendor - cost analysis, risk assessment, and recommendation"
sidebar_label: "Kw Operations Vendor Review"
description: "Evaluate a vendor - cost analysis, risk assessment, and recommendation"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Operations Vendor Review
...
| Path | `skills/knowledge-work/operations/skills/vendor-review` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/operations/skills/vendor-review/../../CONNECTORS.md).
