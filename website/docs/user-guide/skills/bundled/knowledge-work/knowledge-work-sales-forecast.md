---
title: "Kw Sales Forecast — Generate a weighted sales forecast with best/likely/worst scenarios, commit vs"
sidebar_label: "Kw Sales Forecast"
description: "Generate a weighted sales forecast with best/likely/worst scenarios, commit vs"
---
...
| Path | `skills/knowledge-work/sales/skills/forecast` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/sales/skills/forecast/../../CONNECTORS.md).
