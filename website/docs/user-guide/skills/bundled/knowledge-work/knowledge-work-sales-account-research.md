---
title: "Kw Sales Account Research — Research a company or person and get actionable sales intel"
sidebar_label: "Kw Sales Account Research"
description: "Research a company or person and get actionable sales intel"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Sales Account Research
...
| Path | `skills/knowledge-work/sales/skills/account-research` |
...
## Sources
- [Source 1](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/sales/skills/account-research/URL)
- [Source 2](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/sales/skills/account-research/URL)
```
