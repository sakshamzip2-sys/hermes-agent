---
title: "Kw Design Design Critique — Get structured design feedback on usability, hierarchy, and consistency"
sidebar_label: "Kw Design Design Critique"
description: "Get structured design feedback on usability, hierarchy, and consistency"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Design Design Critique
...
| Path | `skills/knowledge-work/design/skills/design-critique` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/design/skills/design-critique/../../CONNECTORS.md).
