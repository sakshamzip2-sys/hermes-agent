---
title: "Kw Data Write Query — Write optimized SQL for your dialect with best practices"
sidebar_label: "Kw Data Write Query"
...
| Path | `skills/knowledge-work/data/skills/write-query` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/data/skills/write-query/../../CONNECTORS.md).
