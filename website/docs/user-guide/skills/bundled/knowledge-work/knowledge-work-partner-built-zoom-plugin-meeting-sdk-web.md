---
title: "Kw Partner Built Zoom Meeting Sdk Web — Zoom Meeting SDK for Web - Embed Zoom meeting capabilities into web applications"
sidebar_label: "Kw Partner Built Zoom Meeting Sdk Web"
description: "Zoom Meeting SDK for Web - Embed Zoom meeting capabilities into web applications"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Zoom Meeting Sdk Web
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web` |
...
[component-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/SKILL.md).
...
3. **SharedArrayBuffer** - [concepts/sharedarraybuffer.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/sharedarraybuffer.md) - Required for HD video, gallery view, virtual backgrounds
4. **Optional preflight diagnostics** - [../../probe-sdk/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/../../probe-sdk/SKILL.md) - Validate browser/device/network before join
...
- Cross-product routing example: [../../general/use-cases/custom-meeting-ui-web.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/../../general/use-cases/custom-meeting-ui-web.md)
- [Browser Support](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/browser-support.md) - Feature matrix by browser
- Exact deep-dive path: [component-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/SKILL.md)
...
- Complete navigation → [SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md)
...
> **Need help with authentication?** See the **[zoom-oauth](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/../../oauth/SKILL.md)** skill for JWT/signature generation.
>
> **Want pre-join diagnostics?** Chain **[probe-sdk](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/../../probe-sdk/SKILL.md)** before `init()`/`join()` to gate low-readiness environments.
...
See [../../probe-sdk/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/../../probe-sdk/SKILL.md) and [../../general/use-cases/probe-sdk-preflight-readiness-gate.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/../../general/use-cases/probe-sdk-preflight-readiness-gate.md).
...
See [concepts/sharedarraybuffer.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/sharedarraybuffer.md) for:
...
**Complete troubleshooting**: [troubleshooting/common-issues.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/troubleshooting/common-issues.md)
...
See [concepts/browser-support.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/browser-support.md) for complete matrix.
...
### Core Documentation
- **[SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md)** - Complete navigation guide
- **[client-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/SKILL.md)** - Full Client View reference
- **[component-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/SKILL.md)** - Full Component View reference

### Concepts
- **[concepts/sharedarraybuffer.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/sharedarraybuffer.md)** - HD video requirements
- **[concepts/browser-support.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/browser-support.md)** - Feature matrix by browser

### Troubleshooting
- **[troubleshooting/error-codes.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/troubleshooting/error-codes.md)** - All SDK error codes
- **[troubleshooting/common-issues.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/troubleshooting/common-issues.md)** - Quick diagnostics

### Examples
- **[client-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/SKILL.md)** - Complete Client View guide
- **[component-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/SKILL.md)** - Component View React integration
...
**Need help?** Start with [SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md) for complete navigation.
...
|----------|-------------|
| **[SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md)** | Main entry point - Quick starts for both Client View and Component View |
...
| Document | Description |
|----------|-------------|
| **[client-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/SKILL.md)** | Complete Client View reference |

### Component View (Embeddable)
| Document | Description |
|----------|-------------|
| **[component-view/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/SKILL.md)** | Complete Component View reference |

## Concepts

| Document | Description |
|----------|-------------|
| **[concepts/sharedarraybuffer.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/sharedarraybuffer.md)** | HD video requirements, COOP/COEP headers |
| **[concepts/browser-support.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/browser-support.md)** | Feature matrix by browser |
...
| Document | Description |
|----------|-------------|
| [examples/client-view-basic.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/examples/client-view-basic.md) | Basic Client View integration |
| [examples/component-view-react.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/examples/component-view-react.md) | React integration with Component View |

## Troubleshooting

| Document | Description |
|----------|-------------|
| **[troubleshooting/error-codes.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/troubleshooting/error-codes.md)** | All SDK error codes (3000-10000 range) |
| **[troubleshooting/common-issues.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/troubleshooting/common-issues.md)** | Quick diagnostics and fixes |

## By Topic

### Authentication
- [SKILL.md#authentication-endpoint](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md#authentication-endpoint-required) - Signature generation
- [SKILL.md#authorization-requirements-2026-update](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md#authorization-requirements-2026-update) - OBF tokens

### HD Video & Performance
- [concepts/sharedarraybuffer.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/concepts/sharedarraybuffer.md) - Enable 720p/1080p

### Events & Callbacks
- [SKILL.md#event-listeners-client-view](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md#event-listeners-client-view) - Client View events
- [SKILL.md#event-listeners-component-view](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md#event-listeners-component-view) - Component View events

### Government (ZFG)
- [SKILL.md#zoom-for-government-zfg](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md#zoom-for-government-zfg) - ZFG configuration

### China CDN
- [SKILL.md#china-cdn](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/SKILL.md#china-cdn) - China-specific CDN
...
- [RUNBOOK.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/RUNBOOK.md) - 5-minute preflight and debugging checklist.
