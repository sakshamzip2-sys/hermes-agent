---
title: "Kw Partner Built Sequence Load — Find leads matching criteria and bulk-add them to an Apollo outreach sequence"
sidebar_label: "Kw Partner Built Sequence Load"
description: "Find leads matching criteria and bulk-add them to an Apollo outreach sequence"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Sequence Load
...
| Path | `skills/knowledge-work/partner-built/apollo/skills/sequence-load` |
