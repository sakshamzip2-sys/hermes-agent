---
title: "Kw Engineering Deploy Checklist — Pre-deployment verification checklist"
sidebar_label: "Kw Engineering Deploy Checklist"
description: "Pre-deployment verification checklist"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Engineering Deploy Checklist
...
| Path | `skills/knowledge-work/engineering/skills/deploy-checklist` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/engineering/skills/deploy-checklist/../../CONNECTORS.md).
