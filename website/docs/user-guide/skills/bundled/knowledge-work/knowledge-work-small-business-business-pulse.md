---
title: "Kw Small Business Business Pulse"
sidebar_label: "Kw Small Business Business Pulse"
description: "Produces a one-page cross-functional business snapshot for SMB owners - cash position (QuickBooks), sales trend (PayPal/Square), pipeline movement (HubSpot),..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Business Pulse
...
| Path | `skills/knowledge-work/small-business/skills/business-pulse` |
