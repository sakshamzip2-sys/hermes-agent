---
title: "Kw Partner Built Compose Outreach — Generate personalized outreach messages using Common Room signals"
sidebar_label: "Kw Partner Built Compose Outreach"
description: "Generate personalized outreach messages using Common Room signals"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Compose Outreach
...
| Path | `skills/knowledge-work/partner-built/common-room/skills/compose-outreach` |
