---
title: "Kw Partner Built Zoom Mcp — Guidance for the bundled Zoom MCP connectors"
sidebar_label: "Kw Partner Built Zoom Mcp"
description: "Guidance for the bundled Zoom MCP connectors"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Zoom Mcp
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp` |
...
Guidance for the bundled Zoom MCP connector in this Claude plugin. Prefer `design-mcp-workflow` or [setup-zoom-mcp](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/../setup-zoom-mcp/SKILL.md) first, then route here for tool-surface details, auth expectations, and MCP-specific constraints.
...
[whiteboard/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/SKILL.md).
...
- The current catalog is documented in [references/tools.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/references/tools.md).
...
requests to [whiteboard/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/SKILL.md).
...
route to [../rest-api/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/../rest-api/SKILL.md).
...
Use [examples/transcript-retrieval.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/examples/transcript-retrieval.md) for the main retrieval
workflow.
...
Full parameter and output guidance: [references/tools.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/references/tools.md)
...
Full error reference: [references/error-codes.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/references/error-codes.md)

## Documentation

### Concepts
- [concepts/mcp-architecture.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/concepts/mcp-architecture.md) - MCP protocol, hosted endpoints, discovery, and capability model
- [concepts/oauth-setup.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/concepts/oauth-setup.md) - OAuth app creation, MCP-specific scopes, AI Companion prerequisites, token lifecycle

### Examples
- [examples/transcript-retrieval.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/examples/transcript-retrieval.md) - Search/assets and recording-resource workflows
- [examples/create-zoom-doc.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/examples/create-zoom-doc.md) - Verified Zoom Docs creation flow
- [examples/search-and-act.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/examples/search-and-act.md) - Search, inspect assets, and hand off CRUD work to REST when needed
- [examples/meeting-lifecycle.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/examples/meeting-lifecycle.md) - Why meeting CRUD belongs in REST, plus the MCP-to-REST handoff pattern

### References
- [references/tools.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/references/tools.md) - Current Zoom MCP tool reference
- [references/error-codes.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/references/error-codes.md) - MCP and Zoom API errors with fixes
- [whiteboard/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/SKILL.md) - Dedicated Whiteboard MCP skill

### Troubleshooting
- [troubleshooting/common-errors.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/troubleshooting/common-errors.md) - Scope failures, endpoint mixups, search/recording issues

### Operations
- [RUNBOOK.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/RUNBOOK.md) - 5-minute preflight and debugging checklist

## Related Skills

- [zoom-rest-api](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/../rest-api/SKILL.md) - Deterministic REST API access, including meeting CRUD
- [zoom-oauth](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/../oauth/SKILL.md) - OAuth implementation patterns
- [zoom-webhooks](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/../webhooks/SKILL.md) - Event-driven recording and meeting workflows
- [zoom-rtms](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/../rtms/SKILL.md) - Live media and transcript streams during active meetings
