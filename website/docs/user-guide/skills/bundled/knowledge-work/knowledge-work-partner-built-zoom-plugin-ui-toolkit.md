---
title: "Kw Partner Built Ui Toolkit Web — Reference skill for Zoom Video SDK UI Toolkit"
sidebar_label: "Kw Partner Built Ui Toolkit Web"
description: "Reference skill for Zoom Video SDK UI Toolkit"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Ui Toolkit Web
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit` |
...
- CSS not loading → See [Troubleshooting](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/troubleshooting/common-issues.md)
- Components not showing → Check Component Lifecycle
- Start with preflight checks → [5-Minute Runbook](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/RUNBOOK.md)
...
- **[troubleshooting/common-issues.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/troubleshooting/common-issues.md)** - CSS, SSR, JWT/session join, customization limits
...
1. **[SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/SKILL.md)** - Main overview and quick start
2. **[5-Minute Runbook](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/RUNBOOK.md)** - Preflight checks before deep debugging
...
See: **[troubleshooting/common-issues.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/troubleshooting/common-issues.md)**
...
### Beginner
1. Read [SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/SKILL.md) overview
...
**Navigation**: [← Back to SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/SKILL.md)

## Environment Variables

- See [references/environment-variables.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/ui-toolkit/references/environment-variables.md) for standardized `.env` keys and where to find each value.
