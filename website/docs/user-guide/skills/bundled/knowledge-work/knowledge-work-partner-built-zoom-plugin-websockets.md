---
title: "Kw Partner Built Setup Zoom Websockets — Reference skill for Zoom WebSockets"
sidebar_label: "Kw Partner Built Setup Zoom Websockets"
description: "Reference skill for Zoom WebSockets"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Setup Zoom Websockets
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/websockets` |
...
> **Need help with S2S OAuth?** See the **[zoom-oauth](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/websockets/../oauth/SKILL.md)** skill for complete authentication flows.

> **Start troubleshooting fast:** Use the **[5-Minute Runbook](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/websockets/RUNBOOK.md)** before deep debugging.
...
- **[references/connection.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/websockets/references/connection.md)** - Connection lifecycle, authentication, error handling
- **[references/events.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/websockets/references/events.md)** - Complete event types reference

## Troubleshooting

- **[troubleshooting/common-issues.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/websockets/troubleshooting/common-issues.md)** - Subscription URL confusion, disconnects, no-events debugging
...
- See [references/environment-variables.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/websockets/references/environment-variables.md) for standardized `.env` keys and where to find each value.
