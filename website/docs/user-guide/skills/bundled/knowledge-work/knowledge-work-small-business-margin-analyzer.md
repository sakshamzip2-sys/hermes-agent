---
title: "Kw Small Business Margin Analyzer"
sidebar_label: "Kw Small Business Margin Analyzer"
description: "Analyzes unit economics by product or service using PayPal merchant insights and QuickBooks cost data, benchmarks against inflation and cost changes, and sho..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Margin Analyzer
...
| Path | `skills/knowledge-work/small-business/skills/margin-analyzer` |
