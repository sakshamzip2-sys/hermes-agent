---
title: "Kw Design Design System — Audit, document, or extend your design system"
sidebar_label: "Kw Design Design System"
description: "Audit, document, or extend your design system"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Design Design System
...
| Path | `skills/knowledge-work/design/skills/design-system` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/design/skills/design-system/../../CONNECTORS.md).
