---
title: "Kw Productivity Start — Initialize the productivity system and open the dashboard"
sidebar_label: "Kw Productivity Start"
description: "Initialize the productivity system and open the dashboard"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Productivity Start
...
| Path | `skills/knowledge-work/productivity/skills/start` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/productivity/skills/start/../../CONNECTORS.md).
