---
title: "Kw Human Resources Comp Analysis — Analyze compensation - benchmarking, band placement, and equity modeling"
sidebar_label: "Kw Human Resources Comp Analysis"
description: "Analyze compensation - benchmarking, band placement, and equity modeling"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Human Resources Comp Analysis
...
| Path | `skills/knowledge-work/human-resources/skills/comp-analysis` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/human-resources/skills/comp-analysis/../../CONNECTORS.md).
