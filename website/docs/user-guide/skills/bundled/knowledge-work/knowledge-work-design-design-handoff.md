---
title: "Kw Design Design Handoff — Generate developer handoff specs from a design"
sidebar_label: "Kw Design Design Handoff"
description: "Generate developer handoff specs from a design"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Design Design Handoff
...
| Path | `skills/knowledge-work/design/skills/design-handoff` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/design/skills/design-handoff/../../CONNECTORS.md).
