---
title: "Kw Pdf Viewer Annotate — Collaboratively annotate a PDF - propose markup, review together, iterate"
sidebar_label: "Kw Pdf Viewer Annotate"
description: "Collaboratively annotate a PDF - propose markup, review together, iterate"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Pdf Viewer Annotate

Collaboratively annotate a PDF - propose markup, review together, iterate
...
| Path | `skills/knowledge-work/pdf-viewer/commands/annotate` |
...
> If you need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/pdf-viewer/commands/annotate/../../CONNECTORS.md).
