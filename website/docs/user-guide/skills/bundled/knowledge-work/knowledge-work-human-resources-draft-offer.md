---
title: "Kw Human Resources Draft Offer — Draft an offer letter with comp details and terms"
sidebar_label: "Kw Human Resources Draft Offer"
description: "Draft an offer letter with comp details and terms"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Human Resources Draft Offer
...
| Path | `skills/knowledge-work/human-resources/skills/draft-offer` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/human-resources/skills/draft-offer/../../CONNECTORS.md).
