---
title: "Kw Bio Research Nextflow Development — Run nf-core bioinformatics pipelines (rnaseq, sarek, atacseq) on sequencing data"
sidebar_label: "Kw Bio Research Nextflow Development"
description: "Run nf-core bioinformatics pipelines (rnaseq, sarek, atacseq) on sequencing data"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Bio Research Nextflow Development
...
| Path | `skills/knowledge-work/bio-research/skills/nextflow-development` |
...
For public datasets, fetch from GEO/SRA first. See [references/geo-sra-acquisition.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/geo-sra-acquisition.md) for the full workflow.
...
**Do not proceed until all checks pass.** For HPC/Singularity, see [references/troubleshooting.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/troubleshooting.md).
...
- [references/pipelines/rnaseq.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/pipelines/rnaseq.md)
- [references/pipelines/sarek.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/pipelines/sarek.md)
- [references/pipelines/atacseq.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/pipelines/atacseq.md)
...
If test fails, see [references/troubleshooting.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/troubleshooting.md).
...
For common exit codes and fixes, see [references/troubleshooting.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/troubleshooting.md).
...
- [references/geo-sra-acquisition.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/geo-sra-acquisition.md) - Downloading public GEO/SRA data
- [references/troubleshooting.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/troubleshooting.md) - Common issues and fixes
- [references/installation.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/installation.md) - Environment setup
- [references/pipelines/rnaseq.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/pipelines/rnaseq.md) - RNA-seq pipeline details
- [references/pipelines/sarek.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/pipelines/sarek.md) - Variant calling details
- [references/pipelines/atacseq.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/bio-research/skills/nextflow-development/references/pipelines/atacseq.md) - ATAC-seq details
