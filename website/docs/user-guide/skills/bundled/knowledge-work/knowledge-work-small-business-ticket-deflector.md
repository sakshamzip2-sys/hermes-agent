---
title: "Kw Small Business Ticket Deflector"
sidebar_label: "Kw Small Business Ticket Deflector"
description: "Reads a forwarded customer email or ticket, pulls order/refund status from PayPal and account history from HubSpot, drafts a tone-matched reply in the owner'..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Ticket Deflector
...
| Path | `skills/knowledge-work/small-business/skills/ticket-deflector` |
...
4. **Draft the reply.** Write in the owner's writing voice. Adjust tone to fit the issue type:
   ...
   Flag any data gaps inline in the draft with a bracketed note (e.g., *[Note: No PayPal transaction found - verify order ID before sending]*) so the owner sees the gap before sending. For a worked example, see [reference/examples/respond-refund-request.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/ticket-deflector/reference/examples/respond-refund-request.md). For common pitfalls, see [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/ticket-deflector/reference/gotchas.md).
...
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/ticket-deflector/reference/gotchas.md) - Good / Bad patterns for tone, PayPal lookup, and ambiguous refund scenarios
- [reference/examples/respond-refund-request.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/ticket-deflector/reference/examples/respond-refund-request.md) - worked example: refund request with PayPal transaction found
