---
title: "Kw Productivity Update — Sync tasks and refresh memory from your current activity"
sidebar_label: "Kw Productivity Update"
description: "Sync tasks and refresh memory from your current activity"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Productivity Update
...
| Path | `skills/knowledge-work/productivity/skills/update` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/productivity/skills/update/../../CONNECTORS.md).
