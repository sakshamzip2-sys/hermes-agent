---
title: "Kw Small Business Month End Prep"
sidebar_label: "Kw Small Business Month End Prep"
description: "Walks an SMB owner through month-end close: reconciles QuickBooks against PayPal (and Square/Stripe) settlements, flags uncategorized transactions, suspiciou..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Month End Prep
...
| Path | `skills/knowledge-work/small-business/skills/month-end-prep` |
...
See [reference/quickbooks-reconcile.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/quickbooks-reconcile.md) for field
...
See [reference/paypal-settlements.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/paypal-settlements.md) for settlement
...
See [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/gotchas.md) for common false-positive patterns
...
See [reference/examples/pl-narrative.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/examples/pl-narrative.md) for a
worked example.
...
See [reference/close-packet-format.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/close-packet-format.md) for column
...
- [reference/quickbooks-reconcile.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/quickbooks-reconcile.md) - QB field
  mappings, API pagination, common data issues
- [reference/paypal-settlements.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/paypal-settlements.md) - settlement
  report structure for PayPal, Square, and Stripe
- [reference/close-packet-format.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/close-packet-format.md) - xlsx column
  specs, PDF layout, file naming convention
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/gotchas.md) - duplicate false positives, split
  transactions, partial-month edge cases
- [reference/examples/pl-narrative.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/month-end-prep/reference/examples/pl-narrative.md) - worked
