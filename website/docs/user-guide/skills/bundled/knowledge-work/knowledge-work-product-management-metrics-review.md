---
title: "Kw Product Management Metrics Review — Review and analyze product metrics with trend analysis and actionable insights"
sidebar_label: "Kw Product Management Metrics Review"
description: "Review and analyze product metrics with trend analysis and actionable insights"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Product Management Metrics Review
...
| Path | `skills/knowledge-work/product-management/skills/metrics-review` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/product-management/skills/metrics-review/../../CONNECTORS.md).
