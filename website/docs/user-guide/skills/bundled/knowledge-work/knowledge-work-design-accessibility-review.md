---
title: "Kw Design Accessibility Review — Run a WCAG 2"
sidebar_label: "Kw Design Accessibility Review"
description: "Run a WCAG 2"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Design Accessibility Review
...
| Path | `skills/knowledge-work/design/skills/accessibility-review` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/design/skills/accessibility-review/../../CONNECTORS.md).
