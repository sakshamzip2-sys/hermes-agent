---
title: "Kw Partner Built Zoom Meeting Sdk Web Component View — Zoom Meeting SDK Web - Component View"
sidebar_label: "Kw Partner Built Zoom Meeting Sdk Web Component View"
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view` |
...
- [Main Web SDK Skill](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/../SKILL.md)
- [Reference Index](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/references/README.md)
- [Error Codes](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/../troubleshooting/error-codes.md)
- [Common Issues](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/../troubleshooting/common-issues.md)
- [SharedArrayBuffer Setup](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/../concepts/sharedarraybuffer.md)
- [Official API Reference](https://marketplacefront.zoom.us/sdk/meeting/web/components/index.html)

## Operations

- [RUNBOOK.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/component-view/RUNBOOK.md) - 5-minute preflight and debugging checklist.
