---
title: "Kw Legal Triage Nda"
sidebar_label: "Kw Legal Triage Nda"
description: "Rapidly triage an incoming NDA and classify it as GREEN (standard approval), YELLOW (counsel review), or RED (full legal review)"
---
...
| Path | `skills/knowledge-work/legal/skills/triage-nda` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/legal/skills/triage-nda/../../CONNECTORS.md).
