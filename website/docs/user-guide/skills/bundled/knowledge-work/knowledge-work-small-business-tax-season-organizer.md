---
title: "Kw Small Business Tax Season Organizer"
sidebar_label: "Kw Small Business Tax Season Organizer"
description: "Prepares tax-season materials for small business owners - framed as deliverables for their accountant, not tax advice"
---
...
| Path | `skills/knowledge-work/small-business/skills/tax-season-organizer` |
...
If QuickBooks is not connected, ask the user to upload a P&L as CSV or paste the key numbers. For field names and query approach, see [reference/connector-queries.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/connector-queries.md).
...
See [reference/calculation-assumptions.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/calculation-assumptions.md) for the full math and the assumptions table you must include in output.
...
For field names and query approach, see [reference/connector-queries.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/connector-queries.md).
...
- [reference/calculation-assumptions.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/calculation-assumptions.md) - full tax math, bracket table, and SE tax walkthrough
- [reference/connector-queries.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/connector-queries.md) - how to pull data from QuickBooks, PayPal, and Stripe
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/gotchas.md) - Good / Bad patterns for common failure modes
- [reference/examples/quarterly-estimate.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/examples/quarterly-estimate.md) - worked quarterly estimate example
- [reference/examples/year-end-1099.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/tax-season-organizer/reference/examples/year-end-1099.md) - worked year-end 1099 prep example
