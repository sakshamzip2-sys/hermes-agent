---
title: "Kw Product Management Stakeholder Update — Generate a stakeholder update tailored to audience and cadence"
sidebar_label: "Kw Product Management Stakeholder Update"
description: "Generate a stakeholder update tailored to audience and cadence"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Product Management Stakeholder Update
...
| Path | `skills/knowledge-work/product-management/skills/stakeholder-update` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/product-management/skills/stakeholder-update/../../CONNECTORS.md).
