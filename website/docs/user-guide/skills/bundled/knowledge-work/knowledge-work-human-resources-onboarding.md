---
title: "Kw Human Resources Onboarding — Generate an onboarding checklist and first-week plan for a new hire"
sidebar_label: "Kw Human Resources Onboarding"
description: "Generate an onboarding checklist and first-week plan for a new hire"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Human Resources Onboarding
...
| Path | `skills/knowledge-work/human-resources/skills/onboarding` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/human-resources/skills/onboarding/../../CONNECTORS.md).
