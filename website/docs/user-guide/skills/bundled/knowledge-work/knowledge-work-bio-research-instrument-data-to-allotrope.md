---
title: "Kw Bio Research Instrument Data To Allotrope"
sidebar_label: "Kw Bio Research Instrument Data To Allotrope"
description: "Convert laboratory instrument output files (PDF, CSV, Excel, TXT) to Allotrope Simple Model (ASM) JSON format or flattened 2D CSV"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Bio Research Instrument Data To Allotrope
...
| Path | `skills/knowledge-work/bio-research/skills/instrument-data-to-allotrope` |
