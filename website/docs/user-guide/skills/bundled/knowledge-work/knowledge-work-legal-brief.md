---
title: "Kw Legal Brief — Generate contextual briefings for legal work - daily summary, topic research, or incident response"
sidebar_label: "Kw Legal Brief"
...
| Path | `skills/knowledge-work/legal/skills/brief` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/legal/skills/brief/../../CONNECTORS.md).
