---
title: "Kw Human Resources Policy Lookup — Find and explain company policies in plain language"
sidebar_label: "Kw Human Resources Policy Lookup"
description: "Find and explain company policies in plain language"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Human Resources Policy Lookup
...
| Path | `skills/knowledge-work/human-resources/skills/policy-lookup` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/human-resources/skills/policy-lookup/../../CONNECTORS.md).
