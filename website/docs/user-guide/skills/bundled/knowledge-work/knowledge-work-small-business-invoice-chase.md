---
title: "Kw Small Business Invoice Chase"
sidebar_label: "Kw Small Business Invoice Chase"
description: "Drafts overdue-invoice reminder emails from QuickBooks and PayPal data, matched to each customer's payment history and tone (gentle for good customers, firm ..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Invoice Chase
...
| Path | `skills/knowledge-work/small-business/skills/invoice-chase` |
| Version | `0.2.0` |
...
3. **Score each customer.** Read [reference/tone-matching.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/tone-matching.md) for scoring logic. Result: `good-payer`, `occasionally-late`, or `repeat-late`.

4. **Draft reminder emails.** One email per customer - consolidate multiple overdue invoices into one email. Match tone to score. See [reference/examples/gentle-reminder.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/examples/gentle-reminder.md) and [reference/examples/firm-reminder.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/examples/firm-reminder.md).
...
- [reference/tone-matching.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/tone-matching.md) - scoring logic, tone guidelines, subject line formulas
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/gotchas.md) - known failure modes
- [reference/examples/gentle-reminder.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/examples/gentle-reminder.md) - good-payer email example
- [reference/examples/firm-reminder.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/invoice-chase/reference/examples/firm-reminder.md) - repeat-late-payer email example
