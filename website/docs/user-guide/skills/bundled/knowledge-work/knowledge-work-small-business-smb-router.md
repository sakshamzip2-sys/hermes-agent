---
title: "Kw Small Business Smb Router — The front door to the Small Business plugin"
sidebar_label: "Kw Small Business Smb Router"
description: "The front door to the Small Business plugin"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Smb Router
...
| Path | `skills/knowledge-work/small-business/skills/smb-router` |
