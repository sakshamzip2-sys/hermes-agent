---
title: "Kw Small Business Canva Creator"
sidebar_label: "Kw Small Business Canva Creator"
description: "Takes an approved content brief and executes a campaign end-to-end: builds the posting calendar, generates Canva designs for social posts, drafts caption and..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Canva Creator
...
| Path | `skills/knowledge-work/small-business/skills/canva-creator` |
...
3. **HubSpot tier.** Social staging requires Marketing Hub Professional.
   ...
   (see [reference/hubspot-staging.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/canva-creator/reference/hubspot-staging.md)).
...
[reference/examples/boutique-brief-campaign.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/canva-creator/reference/examples/boutique-brief-campaign.md).
...
field reference, see
[reference/hubspot-staging.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/canva-creator/reference/hubspot-staging.md).
...
- [reference/canva-api.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/canva-creator/reference/canva-api.md) - Canva Connect API
  endpoints, asset upload, export formats, MCP equivalents
- [reference/hubspot-staging.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/canva-creator/reference/hubspot-staging.md) - HubSpot
  Social API and CSV fallback for non-Pro tiers
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/canva-creator/reference/gotchas.md) - Good / Bad patterns for
