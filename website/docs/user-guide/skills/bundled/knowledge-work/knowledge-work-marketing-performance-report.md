---
title: "Kw Marketing Performance Report"
sidebar_label: "Kw Marketing Performance Report"
description: "Build a marketing performance report with key metrics, trend analysis, wins and misses, and prioritized optimization recommendations"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Marketing Performance Report
...
| Path | `skills/knowledge-work/marketing/skills/performance-report` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/marketing/skills/performance-report/../../CONNECTORS.md).
