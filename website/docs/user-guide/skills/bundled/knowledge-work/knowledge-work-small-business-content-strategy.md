---
title: "Kw Small Business Content Strategy"
sidebar_label: "Kw Small Business Content Strategy"
description: "Analyzes sales data from PayPal and QuickBooks to find top performers and slow movers, layers in seasonality, and produces a prioritized 30-day content brief..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Content Strategy
...
| Path | `skills/knowledge-work/small-business/skills/content-strategy` |
...
See [`reference/gotchas.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/content-strategy/reference/gotchas.md) for common pitfalls.

---

## Examples

See [`reference/examples/`](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/content-strategy/reference/examples/) for worked examples (SaaS, retail, services).
