---
title: "Kw Customer Support Ticket Triage — Triage and prioritize a support ticket or customer issue"
sidebar_label: "Kw Customer Support Ticket Triage"
description: "Triage and prioritize a support ticket or customer issue"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Customer Support Ticket Triage
...
| Path | `skills/knowledge-work/customer-support/skills/ticket-triage` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/customer-support/skills/ticket-triage/../../CONNECTORS.md).
