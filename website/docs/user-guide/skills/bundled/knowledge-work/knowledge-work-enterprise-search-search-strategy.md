---
title: "Kw Enterprise Search Search Strategy — Query decomposition and multi-source search orchestration"
sidebar_label: "Kw Enterprise Search Search Strategy"
description: "Query decomposition and multi-source search orchestration"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Enterprise Search Search Strategy
...
| Path | `skills/knowledge-work/enterprise-search/skills/search-strategy` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/enterprise-search/skills/search-strategy/../../CONNECTORS.md).
