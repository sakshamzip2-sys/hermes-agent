---
title: "Kw Engineering Standup — Generate a standup update from recent activity"
sidebar_label: "Kw Engineering Standup"
description: "Generate a standup update from recent activity"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Engineering Standup
...
| Path | `skills/knowledge-work/engineering/skills/standup` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/engineering/skills/standup/../../CONNECTORS.md).
