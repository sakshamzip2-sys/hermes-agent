---
title: "Kw Customer Support Customer Escalation"
sidebar_label: "Kw Customer Support Customer Escalation"
description: "Package an escalation for engineering, product, or leadership with full context"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Customer Support Customer Escalation
...
| Path | `skills/knowledge-work/customer-support/skills/customer-escalation` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/customer-support/skills/customer-escalation/../../CONNECTORS.md).
