---
title: "Kw Engineering Architecture — Create or evaluate an architecture decision record (ADR)"
sidebar_label: "Kw Engineering Architecture"
...
| Path | `skills/knowledge-work/engineering/skills/architecture` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/engineering/skills/architecture/../../CONNECTORS.md).
