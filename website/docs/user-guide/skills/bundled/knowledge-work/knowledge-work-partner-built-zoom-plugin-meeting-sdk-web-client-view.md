---
title: "Kw Partner Built Zoom Meeting Sdk Web Client View — Zoom Meeting SDK Web - Client View"
sidebar_label: "Kw Partner Built Zoom Meeting Sdk Web Client View"
description: "Zoom Meeting SDK Web - Client View"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Zoom Meeting Sdk Web Client View
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view` |
...
- [Main Web SDK Skill](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/../SKILL.md)
- [Reference Index](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/references/README.md)
- [Error Codes](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/../troubleshooting/error-codes.md)
- [Common Issues](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/../troubleshooting/common-issues.md)
- [SharedArrayBuffer Setup](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/../concepts/sharedarraybuffer.md)
- [Official API Reference](https://marketplacefront.zoom.us/sdk/meeting/web/index.html)

## Operations

- [RUNBOOK.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/meeting-sdk/web/client-view/RUNBOOK.md) - 5-minute preflight and debugging checklist.
