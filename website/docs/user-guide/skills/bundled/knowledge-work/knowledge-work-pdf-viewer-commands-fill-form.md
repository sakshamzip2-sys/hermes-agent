---
title: "Kw Pdf Viewer Fill Form — Fill PDF form fields interactively with live visual feedback"
sidebar_label: "Kw Pdf Viewer Fill Form"
description: "Fill PDF form fields interactively with live visual feedback"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Pdf Viewer Fill Form
...
| Path | `skills/knowledge-work/pdf-viewer/commands/fill-form` |
...
> If you need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/pdf-viewer/commands/fill-form/../../CONNECTORS.md).
