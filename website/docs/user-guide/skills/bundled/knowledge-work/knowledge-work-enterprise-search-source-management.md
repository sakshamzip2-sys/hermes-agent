---
title: "Kw Enterprise Search Source Management — Manages connected MCP sources for enterprise search"
sidebar_label: "Kw Enterprise Search Source Management"
description: "Manages connected MCP sources for enterprise search"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Enterprise Search Source Management
...
| Path | `skills/knowledge-work/enterprise-search/skills/source-management` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/enterprise-search/skills/source-management/../../CONNECTORS.md).
