---
title: "Kw Customer Support Customer Research — Multi-source research on a customer question or topic with source attribution"
sidebar_label: "Kw Customer Support Customer Research"
description: "Multi-source research on a customer question or topic with source attribution"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Customer Support Customer Research
...
| Path | `skills/knowledge-work/customer-support/skills/customer-research` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/customer-support/skills/customer-research/../../CONNECTORS.md).
