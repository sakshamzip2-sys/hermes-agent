---
title: "Kw Finance Journal Entry — Prepare journal entries with proper debits, credits, and supporting detail"
sidebar_label: "Kw Finance Journal Entry"
description: "Prepare journal entries with proper debits, credits, and supporting detail"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Finance Journal Entry
...
| Path | `skills/knowledge-work/finance/skills/journal-entry` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/finance/skills/journal-entry/../../CONNECTORS.md).
