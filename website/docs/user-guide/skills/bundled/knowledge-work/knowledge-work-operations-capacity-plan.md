---
title: "Kw Operations Capacity Plan — Plan resource capacity - workload analysis and utilization forecasting"
sidebar_label: "Kw Operations Capacity Plan"
description: "Plan resource capacity - workload analysis and utilization forecasting"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Operations Capacity Plan
...
| Path | `skills/knowledge-work/operations/skills/capacity-plan` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/operations/skills/capacity-plan/../../CONNECTORS.md).
