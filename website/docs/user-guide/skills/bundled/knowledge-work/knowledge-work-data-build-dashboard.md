---
title: "Kw Data Build Dashboard — Build an interactive HTML dashboard with charts, filters, and tables"
sidebar_label: "Kw Data Build Dashboard"
description: "Build an interactive HTML dashboard with charts, filters, and tables"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Data Build Dashboard
...
| Path | `skills/knowledge-work/data/skills/build-dashboard` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/data/skills/build-dashboard/../../CONNECTORS.md).
