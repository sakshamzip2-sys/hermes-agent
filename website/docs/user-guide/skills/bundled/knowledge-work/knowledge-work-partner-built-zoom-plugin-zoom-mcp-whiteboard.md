---
title: "Kw Partner Built Zoom Mcp Whiteboard — Guidance for the bundled Zoom Whiteboard MCP connector"
sidebar_label: "Kw Partner Built Zoom Mcp Whiteboard"
description: "Guidance for the bundled Zoom Whiteboard MCP connector"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Zoom Mcp Whiteboard
...
| Path | `skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard` |
...
Reference: [references/authentication-and-identifiers.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/references/authentication-and-identifiers.md)
...
Reference: [references/tools.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/references/tools.md)
...
- Parent MCP skill: [../SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/../SKILL.md)
- OAuth guidance: [../concepts/oauth-setup.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/../concepts/oauth-setup.md)
- General routing: [../../general/SKILL.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/../../general/SKILL.md)

## References

- [references/authentication-and-identifiers.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/references/authentication-and-identifiers.md) - Auth behavior and Whiteboard ID mapping.
- [references/tools.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/partner-built/zoom-plugin/skills/zoom-mcp/whiteboard/references/tools.md) - Whiteboard MCP tool catalog.
