---
title: "Kw Small Business Customer Pulse"
sidebar_label: "Kw Small Business Customer Pulse"
description: "Aggregates PayPal disputes, HubSpot feedback and tickets, and email sentiment (plus pasted or exported Google/Yelp reviews) into a themes report with verbati..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Customer Pulse
...
| Path | `skills/knowledge-work/small-business/skills/customer-pulse` |
| Version | `0.2.0` |
...
2. **Pull PayPal disputes.** Fetch disputes opened in the window. If the PayPal API returns a rate-limit error, skip and add `PayPal: rate-limited - not included` to the Sources section. Do not retry; do not error. See [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/customer-pulse/reference/gotchas.md) for the rate-limit pattern.
...
7. **Extract themes.** Group all evidence into 3–5 recurring themes. Each theme must include:
   ...
   Verbatim quotes are non-negotiable - never paraphrase. See [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/customer-pulse/reference/gotchas.md) for the verbatim anti-pattern.
...
9. **Deliver the report.** Structure the output with these sections in order:
   ...
   For a complete worked example, see [reference/examples/example-report.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/customer-pulse/reference/examples/example-report.md).
...
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/customer-pulse/reference/gotchas.md) - PayPal rate limits, HubSpot empty state, verbatim quote requirement, Gmail keyword drift
- [reference/examples/example-report.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/customer-pulse/reference/examples/example-report.md) - full worked example output
