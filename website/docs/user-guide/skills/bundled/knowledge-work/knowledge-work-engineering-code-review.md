---
title: "Kw Engineering Code Review — Review code changes for security, performance, and correctness"
sidebar_label: "Kw Engineering Code Review"
description: "Review code changes for security, performance, and correctness"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Engineering Code Review
...
| Path | `skills/knowledge-work/engineering/skills/code-review` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/engineering/skills/code-review/../../CONNECTORS.md).
