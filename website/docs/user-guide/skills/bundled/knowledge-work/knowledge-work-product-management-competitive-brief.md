---
title: "Kw Product Management Competitive Brief"
sidebar_label: "Kw Product Management Competitive Brief"
description: "Create a competitive analysis brief for one or more competitors or a feature area"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Product Management Competitive Brief
...
| Path | `skills/knowledge-work/product-management/skills/competitive-brief` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/product-management/skills/competitive-brief/../../CONNECTORS.md).
