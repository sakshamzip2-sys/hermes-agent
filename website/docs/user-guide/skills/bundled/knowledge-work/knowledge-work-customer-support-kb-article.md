---
title: "Kw Customer Support Kb Article — Draft a knowledge base article from a resolved issue or common question"
sidebar_label: "Kw Customer Support Kb Article"
description: "Draft a knowledge base article from a resolved issue or common question"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Customer Support Kb Article
...
| Path | `skills/knowledge-work/customer-support/skills/kb-article` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/customer-support/skills/kb-article/../../CONNECTORS.md).
