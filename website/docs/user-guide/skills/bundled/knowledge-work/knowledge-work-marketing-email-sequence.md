---
title: "Kw Marketing Email Sequence"
sidebar_label: "Kw Marketing Email Sequence"
description: "Design and draft multi-email sequences with full copy, timing, branching logic, exit conditions, and performance benchmarks"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Marketing Email Sequence
...
| Path | `skills/knowledge-work/marketing/skills/email-sequence` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/marketing/skills/email-sequence/../../CONNECTORS.md).
