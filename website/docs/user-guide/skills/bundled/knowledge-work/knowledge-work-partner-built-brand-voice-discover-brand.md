---
title: "Kw Partner Built Discover Brand"
sidebar_label: "Kw Partner Built Discover Brand"
description: "This skill orchestrates autonomous discovery of brand materials across enterprise platforms (Notion, Confluence, Google Drive, Box, SharePoint, Figma, Gong, ..."
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Partner Built Discover Brand
...
| Path | `skills/knowledge-work/partner-built/brand-voice/skills/discover-brand` |
