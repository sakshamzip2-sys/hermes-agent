---
title: "Kw Operations Change Request — Create a change management request with impact analysis and rollback plan"
sidebar_label: "Kw Operations Change Request"
description: "Create a change management request with impact analysis and rollback plan"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Operations Change Request
...
| Path | `skills/knowledge-work/operations/skills/change-request` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/operations/skills/change-request/../../CONNECTORS.md).
