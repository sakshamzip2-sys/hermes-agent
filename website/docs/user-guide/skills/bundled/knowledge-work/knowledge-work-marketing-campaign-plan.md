---
title: "Kw Marketing Campaign Plan"
sidebar_label: "Kw Marketing Campaign Plan"
description: "Generate a full campaign brief with objectives, audience, messaging, channel strategy, content calendar, and success metrics"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Marketing Campaign Plan
...
| Path | `skills/knowledge-work/marketing/skills/campaign-plan` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/marketing/skills/campaign-plan/../../CONNECTORS.md).
