---
title: "Kw Product Management Sprint Planning"
sidebar_label: "Kw Product Management Sprint Planning"
description: "Plan a sprint - scope work, estimate capacity, set goals, and draft a sprint plan"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Product Management Sprint Planning
...
| Path | `skills/knowledge-work/product-management/skills/sprint-planning` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/product-management/skills/sprint-planning/../../CONNECTORS.md).
