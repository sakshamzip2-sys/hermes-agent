---
title: "Kw Finance Financial Statements"
sidebar_label: "Kw Finance Financial Statements"
description: "Generate financial statements (income statement, balance sheet, cash flow) with period-over-period comparison and variance analysis"
---
...
| Path | `skills/knowledge-work/finance/skills/financial-statements` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/finance/skills/financial-statements/../../CONNECTORS.md).
