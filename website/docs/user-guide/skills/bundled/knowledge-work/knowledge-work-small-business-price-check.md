---
title: "Kw Small Business Price Check"
sidebar_label: "Kw Small Business Price Check"
description: "Produces a margin-by-product table and three pricing-scenario data views so the owner can see the full financial picture before making a pricing decision"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Price Check
...
| Path | `skills/knowledge-work/small-business/skills/price-check` |
