---
title: "Kw Data Explore Data — Profile and explore a dataset to understand its shape, quality, and patterns"
sidebar_label: "Kw Data Explore Data"
description: "Profile and explore a dataset to understand its shape, quality, and patterns"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Data Explore Data
...
| Path | `skills/knowledge-work/data/skills/explore-data` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/data/skills/explore-data/../../CONNECTORS.md).
