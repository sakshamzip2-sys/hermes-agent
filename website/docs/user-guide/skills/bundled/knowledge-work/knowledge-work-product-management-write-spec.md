---
title: "Kw Product Management Write Spec — Write a feature spec or PRD from a problem statement or feature idea"
sidebar_label: "Kw Product Management Write Spec"
description: "Write a feature spec or PRD from a problem statement or feature idea"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Product Management Write Spec
...
| Path | `skills/knowledge-work/product-management/skills/write-spec` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/product-management/skills/write-spec/../../CONNECTORS.md).
