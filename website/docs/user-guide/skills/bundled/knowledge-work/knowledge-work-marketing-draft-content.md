---
title: "Kw Marketing Draft Content"
sidebar_label: "Kw Marketing Draft Content"
description: "Draft blog posts, social media, email newsletters, landing pages, press releases, and case studies with channel-specific formatting and SEO recommendations"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Marketing Draft Content
...
| Path | `skills/knowledge-work/marketing/skills/draft-content` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/marketing/skills/draft-content/../../CONNECTORS.md).
