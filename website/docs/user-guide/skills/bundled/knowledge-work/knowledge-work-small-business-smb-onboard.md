---
title: "Kw Small Business Smb Onboard — Claude as the trainer"
sidebar_label: "Kw Small Business Smb Onboard"
description: "Claude as the trainer"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Kw Small Business Smb Onboard
...
| Path | `skills/knowledge-work/small-business/skills/smb-onboard` |
...
2. **Pick two functions, then check what the owner uses.** Ask: *"What are your biggest day-to-day headaches - money, customers, scheduling, or getting organized?"* Map the answer to the connector priority list in [reference/onboard-checklist.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/onboard-checklist.md).
   ...
   Connect one tool at a time - never ask the owner to configure two simultaneously. See [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/gotchas.md) for the failure pattern this replaces.

3. **Run one recipe to prove value.** Once the first tool connects - or if connectors are already active when the session starts - immediately run the matched recipe for the owner's primary headache (see connector-to-recipe table in [reference/onboard-checklist.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/onboard-checklist.md)). Narrate what Claude is doing and why - this is the "aha" moment. Do not skip it to get to the interview faster. For a worked example of the full arc, see [reference/examples/happy-path.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/examples/happy-path.md).

4. **Interview the owner.** Ask the five questions from [reference/onboard-checklist.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/onboard-checklist.md), one at a time, conversationally. Wait for the full answer before moving to the next. If the owner seems pressed for time, compress to three: industry, headaches, tools - but never fewer.

5. **Store context.** Show the owner the full profile before writing. Wait for explicit approval. Write the block to the Cowork session memory directory under the heading `## Business context` using the exact format in [reference/onboard-checklist.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/onboard-checklist.md). If a memory file already exists, update only the `## Business context` section - do not touch other content. Confirm: *"Saved. Every skill from here will know your business."*
...
- [reference/onboard-checklist.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/onboard-checklist.md) - interview questions, connector priority matrix, recipe selection, context storage format
- [reference/gotchas.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/gotchas.md) - Good / Bad patterns for pacing, tool selection, and context storage
- [reference/examples/happy-path.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/small-business/skills/smb-onboard/reference/examples/happy-path.md) - worked example: retail shop owner, first session end-to-end
