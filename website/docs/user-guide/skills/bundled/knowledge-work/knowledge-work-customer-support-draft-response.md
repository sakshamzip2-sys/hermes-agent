---
title: "Kw Customer Support Draft Response"
sidebar_label: "Kw Customer Support Draft Response"
...
# Kw Customer Support Draft Response
...
| Path | `skills/knowledge-work/customer-support/skills/draft-response` |
...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/knowledge-work/customer-support/skills/draft-response/../../CONNECTORS.md).
