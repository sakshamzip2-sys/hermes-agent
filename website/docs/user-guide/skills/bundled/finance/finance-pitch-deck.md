---
title: "Pitch Deck — Populates investment banking pitch deck templates with data from source files"
sidebar_label: "Pitch Deck"
description: "Populates investment banking pitch deck templates with data from source files"
---
...
| Path | `skills/finance/pitch-deck` |
...
| File | Purpose |
|------|---------|
| [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md) | Text, bullets, tables, charts, alignment |
| [`slide-templates.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/slide-templates.md) | Content mapping guidance for common slide types |
| [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md) | PowerPoint XML patterns for tables, shapes, arrows |
| [`calculation-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/calculation-standards.md) | Financial formulas for verification (CAGR, consensus) |
...
6. Note any calculations that need verification → see [`calculation-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/calculation-standards.md) for formulas
...
3. Map source data to corresponding template sections → see [`slide-templates.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/slide-templates.md) for mapping guidance
4. Identify placeholder guidance boxes (colored instruction boxes from task creator)
5. Note any data gaps or mismatches → see [`slide-templates.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/slide-templates.md#handling-data-template-mismatches) for resolution
...
3. **Then apply formatting** to match template style → see [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md)
4. Create tables as actual table objects (NEVER use pipe/tab-separated text) → see [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#table-implementation)
5. Create arrows/shapes as PowerPoint objects → see [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#arrow-shapes)
...
| **Actual Table Objects** | Tabular data MUST be table objects, not tab-separated text. See [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#table-implementation). |
| **Proper Chart/Table Sizing** | Pasted visuals MUST fill designated area. See [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md#chart-and-image-handling). |
...
**MUST verify:** After creating any table, verify it is an actual table object. See [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#critical-verify-tables-are-actual-table-objects) for verification methods.
...
|---------|----------|-----------|
| Unstructured text dumps | Break into bullets (✓, ×, •) | [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md#bullet-point-structure) |
| Pipe/tab-separated "tables" | Create actual table objects, text with separators is NOT a table | [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#table-implementation) |
| Poor text/background contrast | Audit every text element |, |
| Tiny pasted charts | Resize to fill area, paste chart only | [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md#proper-sizing-workflow) |
...
| Inconsistent bullets | Define style once, apply to all | [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md#bullet-consistency) |
| Inconsistent fonts across boxes | Standardize same-level boxes | [`formatting-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/formatting-standards.md#font-consistency) |
...
| Text arrows (→, ⟹) | Use PowerPoint shape objects | [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#arrow-shapes) |
...
For XML implementation, see [`xml-reference.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/xml-reference.md#table-implementation).
...
For detailed data requirements, formatting principles, and example column headers for each slide type, see [`slide-templates.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/slide-templates.md#common-slide-types-and-data-requirements).
...
- [ ] Calculated values verified against formulas (see [`calculation-standards.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/pitch-deck/reference/calculation-standards.md))
