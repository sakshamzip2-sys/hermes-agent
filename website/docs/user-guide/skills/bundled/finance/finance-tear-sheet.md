---
title: "Tear Sheet — Generate professional company tear sheets using S&P Capital IQ data via the Kensho LLM-ready API MCP server"
sidebar_label: "Tear Sheet"
...
| Path | `skills/finance/tear-sheet` |
