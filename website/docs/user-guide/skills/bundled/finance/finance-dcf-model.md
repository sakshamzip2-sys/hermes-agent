---
title: "Dcf Model — Real DCF (Discounted Cash Flow) model creation for equity valuation"
sidebar_label: "Dcf Model"
description: "Real DCF (Discounted Cash Flow) model creation for equity valuation"
---
...
**If you encounter errors or unreasonable results, read [TROUBLESHOOTING.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/dcf-model/TROUBLESHOOTING.md) for detailed debugging guidance.**
...
3. **Check output**:
   ...
   - If `status` is `"errors_found"` → Check `error_summary` and read [TROUBLESHOOTING.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/dcf-model/TROUBLESHOOTING.md) for debugging guidance
