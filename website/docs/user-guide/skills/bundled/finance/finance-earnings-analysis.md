...
sidebar_label: "Earnings Analysis"
...
| Path | `skills/finance/earnings-analysis` |
...
**See [references/workflow.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/earnings-analysis/references/workflow.md)** for detailed search procedures and verification steps.
...
**See [references/workflow.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/earnings-analysis/references/workflow.md)** for detailed analysis framework.
...
**See [references/workflow.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/earnings-analysis/references/workflow.md)** for chart specifications.

### Phase 4: Report Creation (2-3 hours)
Create 8-12 page DOCX report with specific structure.

**See [references/report-structure.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/earnings-analysis/references/report-structure.md)** for complete page-by-page templates and formatting requirements.
...
**See [references/best-practices.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/finance/earnings-analysis/references/best-practices.md)** for quality checklist and common mistakes to avoid.
