---
title: "Break Trace"
sidebar_label: "Break Trace"
description: "Root-cause a reconciliation break to its source transaction or posting, follow the audit trail from the break row back to the originating entry on each side ..."
---
...
| Path | `skills/finance/break-trace` |
