...
description: "Analyze unit economics for PE targets, ARR cohorts, LTV/CAC, net retention, payback periods, revenue quality, and margin waterfall"
---
...
| Path | `skills/finance/unit-economics` |
