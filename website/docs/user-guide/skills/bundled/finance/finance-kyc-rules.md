---
title: "Kyc Rules"
sidebar_label: "Kyc Rules"
description: "Apply the firm's KYC/AML rules grid to a parsed onboarding record, assign a risk rating, list every rule outcome with the rule cited, and flag what's missing..."
---
