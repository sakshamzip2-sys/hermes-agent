---
title: "Project Memory — Repo-level memory so a coding agent never rediscovers the same project twice"
sidebar_label: "Project Memory"
description: "Repo-level memory so a coding agent never rediscovers the same project twice"
---
