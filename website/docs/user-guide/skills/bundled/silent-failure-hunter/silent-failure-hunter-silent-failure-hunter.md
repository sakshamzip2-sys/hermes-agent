---
title: "Silent Failure Hunter — Audit code for swallowed errors and silent failures"
sidebar_label: "Silent Failure Hunter"
...
Audit code for swallowed errors and silent failures.
...
| Path | `skills/silent-failure-hunter` |
| Version | `1.0.0` |
