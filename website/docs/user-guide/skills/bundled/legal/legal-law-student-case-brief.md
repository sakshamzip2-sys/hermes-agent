---
title: "Law Student Case Brief — Brief a case in your preferred format"
sidebar_label: "Law Student Case Brief"
description: "Brief a case in your preferred format"
---
...
| Path | `skills/legal/law-student/case-brief` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → outline/brief preferences.
...
`~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → outline/brief preferences (format, depth), learning style.
...
Per the student's format in `~/.hermes/legal-practice-profile/law-student/CLAUDE.md`. If none captured, default:
...
Per `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` -- some students want one-line briefs (rule + cite), some want full treatment. Match their format.
