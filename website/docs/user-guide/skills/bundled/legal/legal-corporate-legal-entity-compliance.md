---
title: "Corporate Legal Entity Compliance"
sidebar_label: "Corporate Legal Entity Compliance"
...
| Path | `skills/legal/corporate-legal/entity-compliance` |
...
1. Load `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` → `## Entity Management` (entity table, jurisdictions, registered agent).
...
3. Read/write `~/.hermes/legal-practice-profile/corporate-legal/entities/compliance-tracker.yaml`.
...
Lives at `~/.hermes/legal-practice-profile/corporate-legal/entities/compliance-tracker.yaml`. Structure:
...
Read `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` → `## Entity Management` → Entity table. If the entity table
...
Generate `~/.hermes/legal-practice-profile/corporate-legal/entities/compliance-tracker.yaml` with all entities and their
...
**Before directing or confirming a filing:** Read `## Who's using this` in `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
...
- Based on `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` entity table: are there states in the company's
...
- From `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md`: if intercompany agreements are marked as partial or no,
...
POTENTIAL GAPS
  Foreign qualification: [flag question -- confirm operational presence in:]
    [list of states from `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` footprint not in tracker as qualified]
  Intercompany agreements: [status from `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md`]
