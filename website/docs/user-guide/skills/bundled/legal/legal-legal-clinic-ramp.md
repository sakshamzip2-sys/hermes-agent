---
title: "Legal Clinic Ramp"
sidebar_label: "Legal Clinic Ramp"
description: "Student semester onboarding -- clinic procedures, tool walkthrough, practice exercises before real cases"
---
...
| Path | `skills/legal/legal-clinic/ramp` |
...
1. Check `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` is set up. If placeholders: "Ask [professor] to run `/legal-clinic:cold-start-interview` first."
...
`~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → clinic profile, practice areas, jurisdiction, handbook path, supervision style, practice-area templates.
...
Read from `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` and the ingested handbook. Cover, interactively:
