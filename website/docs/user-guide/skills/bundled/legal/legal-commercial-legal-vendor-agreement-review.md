---
title: "Commercial Legal Vendor Agreement Review"
sidebar_label: "Commercial Legal Vendor Agreement Review"
description: "Reference: review of an inbound vendor agreement against the team playbook in `~/"
---
...
Reference: review of an inbound vendor agreement against the team playbook in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`. Flags deviations, assesses risk, generates specific redline language, and routes to the right approver. Loaded by /commercial-legal:review when a vendor MSA, services agreement, or similar is detected.
...
| Path | `skills/legal/commercial-legal/vendor-agreement-review` |
...
Read a vendor agreement against the playbook this team actually uses (in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`), find every term that deviates, and tell the lawyer what to do about each one -- with specific redline language, not vague "consider revising."
...
**Before reading the contract, read `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`.** If it's missing or still has placeholders, surface this bounce:
...
The playbook in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` is the source of truth. It tells you:
...
Check the "one thing" from `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` first. If present:
...
For each playbook category in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`, find the corresponding contract section and compare.
...
**Playbook says:** [our standard position, quoted from `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`]
...
**If they won't move:** [the fallback from `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`, or "escalate to [person]"
...
| Level | Means |
|---|---|
| 🔴 Critical | Don't sign without fixing. A term on the team's "never accept" list in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`, or a deal-breaker. |
...
Severity is always applied *against `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`*. If a term doesn't map cleanly to a playbook position, ask the user which bucket it belongs in and offer to record the answer in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`.
...
Check the escalation matrix in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` against:
...
**Before proceeding to send redlines to the counterparty:** Read `## Who's using this` in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Before generating a signature envelope or routing for countersignature:** Read `## Who's using this` in `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Full memo (default):** As above. Goes in the [CLM] record or the Drive folder from `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` house-style section.
...
- [ ] `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` was loaded and quoted -- not generic market positions
