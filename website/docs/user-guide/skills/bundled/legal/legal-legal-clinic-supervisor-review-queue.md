---
title: "Legal Clinic Supervisor Review Queue"
sidebar_label: "Legal Clinic Supervisor Review Queue"
description: "Professor's review queue -- student output waits here for professor approval before going to clients or courts"
---
...
| Path | `skills/legal/legal-clinic/supervisor-review-queue` |
...
1. Check `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → supervision style. If NOT "formal review queue": explain the clinic is set up for [flags/lighter-touch], no formal queue exists, and how to switch.
...
**This skill is only active if `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → Supervision style is "formal review queue."** Otherwise it's dormant -- the cold-start interview asks the professor which model they want, and this is one of three options.
