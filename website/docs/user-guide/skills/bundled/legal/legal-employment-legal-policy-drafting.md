---
title: "Employment Legal Policy Drafting"
sidebar_label: "Employment Legal Policy Drafting"
...
| Path | `skills/legal/employment-legal/policy-drafting` |
...
1. Load `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → jurisdictional footprint, handbook location.
...
`~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → jurisdictional footprint, handbook location and format.
