---
title: "Employment Legal International Expansion"
sidebar_label: "Employment Legal International Expansion"
...
| Path | `skills/legal/employment-legal/international-expansion` |
...
Read `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `~/.hermes/legal-practice-profile/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.hermes/legal-practice-profile/employment-legal/expansion-[slug].yaml
