---
title: "Corporate Legal Closing Checklist"
sidebar_label: "Corporate Legal Closing Checklist"
...
| Path | `skills/legal/corporate-legal/closing-checklist` |
...
1. Read `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/closing-checklist.yaml` and use the modes below.
...
Lives at `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/closing-checklist.yaml`. Structure:
...
**Before producing a "ready to close / all CPs satisfied" certification or closing memo:** Read `## Who's using this` in `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
