---
title: "Privacy Legal Reg Gap Analysis"
sidebar_label: "Privacy Legal Reg Gap Analysis"
...
| Path | `skills/legal/privacy-legal/reg-gap-analysis` |
...
1. Load `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` → privacy policy commitments, regulatory footprint, DSAR systems.
...
This skill diffs the new requirement against what you currently do (per `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` → Privacy policy commitments + the practices documented in PIAs) and produces a gap list with a remediation plan.
