---
title: "Litigation Legal Brief Section Drafter"
sidebar_label: "Litigation Legal Brief Section Drafter"
...
| Path | `skills/legal/litigation-legal/brief-section-drafter` |
...
1. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → case theory, house style.
...
`~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → case theory, house style (citation format, structure, tone, length norms).

**Conflicts gate -- unbypassable.** Before drafting, check `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` for the matter slug this skill is being invoked on. If the matter is not in `_log.yaml`, refuse and route:
...
Per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`:
...
**Before the brief is filed (the consequential act -- this skill drafts, but the gate runs at the filing step regardless of who triggers it):** Read `## Who's using this` in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
