---
title: "Product Legal Marketing Claims Review — Review marketing copy for claims that need substantiation, reframing, or cutting"
sidebar_label: "Product Legal Marketing Claims Review"
...
| Path | `skills/legal/product-legal/marketing-claims-review` |
...
1. Load `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` → Marketing claims standards.
...
Read `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` → `## Marketing claims`:
...
Per `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` -- if comparative claims are "never," flag all of them. If "allowed with substantiation," check for the substantiation.
...
Prepend the work-product header from `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` `## Outputs` (it differs by user role -- see `## Who's using this`).
...
> **Before emitting "Ready to ship: Yes" (i.e., approving a claim for external use / publication):** Read `## Who's using this` in `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md`. If the Role is Non-lawyer:
>
