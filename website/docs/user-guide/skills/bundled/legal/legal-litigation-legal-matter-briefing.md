---
title: "Litigation Legal Matter Briefing"
sidebar_label: "Litigation Legal Matter Briefing"
description: "Deep briefing on one matter -- current posture, what's changed, next deadline, open questions, and a risk re-assessment check, ready before a GC update or ou..."
---
...
| Path | `skills/legal/litigation-legal/matter-briefing` |
...
1. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → risk calibration + relevant stakeholders.
2. Follow the workflow and reference below.
3. Read `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` + `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md` + log row from `_log.yaml`.
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` -- structured row
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` -- narrative intake
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md` -- event log
- `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` -- risk calibration (so "risk: high" means something specific, not generic)
