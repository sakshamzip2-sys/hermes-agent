---
title: "Employment Legal Expansion Kickoff"
sidebar_label: "Employment Legal Expansion Kickoff"
...
| Path | `skills/legal/employment-legal/expansion-kickoff` |
...
3. If a tracker file already exists for this country (`~/.hermes/legal-practice-profile/employment-legal/expansion-[slug].yaml`),
...
4. Create `~/.hermes/legal-practice-profile/employment-legal/expansion-[slug].yaml` on completion.
