---
title: "Privacy Legal Use Case Triage"
sidebar_label: "Privacy Legal Use Case Triage"
description: "Quickly determine whether a processing activity needs a PIA, a mandatory GDPR DPIA, or can proceed -- surfaces privacy policy conflicts and routes to the rig..."
---
...
| Path | `skills/legal/privacy-legal/use-case-triage` |
...
1. Read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md`. Confirm privacy practice is configured -- if not, stop and direct to setup.
...
Before triaging, always read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md`. The PIA trigger criteria, regulatory
...
Read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` → `## PIA house style` → Trigger criteria. Apply them.
...
Read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` → `## Privacy policy commitments`. Check the proposed activity
