---
title: "Litigation Legal Matter Update"
sidebar_label: "Litigation Legal Matter Update"
description: "Append a dated event to a matter's history file and refresh the log row -- captures new developments, status changes, risk re-assessments, deadline shifts, a..."
---
...
| Path | `skills/legal/litigation-legal/matter-update` |
...
2. Confirm slug exists in `~/.hermes/legal-practice-profile/litigation-legal/matters/` and `_log.yaml`.
...
4. Append dated entry to `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md`.
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` -- find the row
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md` -- append target
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` -- reference (don't rewrite)
- `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` -- risk calibration (if re-assessing risk)
...
If the Strategy update is a **settlement acceptance** (the company is accepting a settlement offer, executing a settlement agreement, or authorizing acceptance in principle -- not merely logging an offer made or received): Read `## Who's using this` in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
If materiality moves to `reserved` or `disclosed`, and the matter did not previously carry a reserve or disclosure, flag the event as requiring finance / audit-committee notification per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` materiality thresholds.
...
### Append to `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md`
...
### Update `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml`
