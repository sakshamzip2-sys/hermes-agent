---
title: "Law Student Outline Builder — Build or extend a course outline in your format, from class notes and casebook"
sidebar_label: "Law Student Outline Builder"
description: "Build or extend a course outline in your format, from class notes and casebook"
---
...
| Path | `skills/legal/law-student/outline-builder` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → outline preferences, existing outlines.
...
1. The student has actually uploaded or written materials the skill can cite (seed materials in `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → Seed materials, or an earlier section of the outline being extended), and
...
`~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → outline preferences (format, depth, existing outlines location).
