---
title: "Ip Legal Fto Triage"
sidebar_label: "Ip Legal Fto Triage"
...
| Path | `skills/legal/ip-legal/fto-triage` |
...
Before running triage, read `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`. Pull:
...
Prepend the work-product header from `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md` `## Outputs`. Mark the document as privileged if the role is lawyer; see the non-lawyer gate below if not.
...
`~/.hermes/legal-practice-profile/ip-legal/matters/<matter-slug>/outputs/fto-triage-<subject-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.hermes/legal-practice-profile/ip-legal/outputs/fto-triage-<subject-slug>-YYYY-MM-DD.md`
