---
title: "Corporate Legal Integration Management"
sidebar_label: "Corporate Legal Integration Management"
...
| Path | `skills/legal/corporate-legal/integration-management` |
...
5. Read/write `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
Read `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/closing-checklist.yaml`
