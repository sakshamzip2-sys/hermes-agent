---
title: "Legal Clinic Deadlines — Track case deadlines -- add, cross-case rollup report, update, complete, close"
sidebar_label: "Legal Clinic Deadlines"
description: "Track case deadlines -- add, cross-case rollup report, update, complete, close"
---
...
| Path | `skills/legal/legal-clinic/deadlines` |
...
1. Load `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → jurisdiction, practice areas, warning-day cadence.
2. Use the workflow below.
3. Route by flag:
   - `--add`: capture case, type, description, due date, source, owner. Write to `~/.hermes/legal-practice-profile/legal-clinic/deadlines.yaml`. Check for duplicates first.
...
- `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → jurisdiction, practice areas, deadline warning days (default 14/7/3/1), supervising attorneys
- `~/.hermes/legal-practice-profile/legal-clinic/deadlines.yaml` -- the ledger
...
Read `~/.hermes/legal-practice-profile/legal-clinic/deadlines.yaml`. Produce:
...
Per `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` deadline warning days. Default 14, 7, 3, 1.
...
- **`/status`:** the status skill reads `~/.hermes/legal-practice-profile/legal-clinic/deadlines.yaml` for the relevant case and includes upcoming deadlines in its output.
