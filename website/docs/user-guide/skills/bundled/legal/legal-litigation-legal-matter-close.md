...
sidebar_label: "Litigation Legal Matter Close"
...
| Path | `skills/legal/litigation-legal/matter-close` |
...
5. Append final entry to `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md`.
6. Matter stays in `_log.yaml` and `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/` -- not deleted. `/portfolio-status` filters it from active rollups.
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` -- reference (intake context)
...
**Before closing the matter (the consequential act -- the matter is archived and active tracking ends):** Read `## Who's using this` in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
### Append final entry to `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md`
...
### Touch `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md`
