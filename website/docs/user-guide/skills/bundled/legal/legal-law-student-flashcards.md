---
title: "Law Student Flashcards"
sidebar_label: "Law Student Flashcards"
description: "Generate or drill flashcards for black-letter memorization -- Leitner-style buckets, per-subject markdown storage, drill mode with self-assessment"
---
...
| Path | `skills/legal/law-student/flashcards` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → current classes, weak subjects, outline locations.
2. Apply the framework below.
3. Route by flag:
   - `--generate`: build cards from source (outline path, notes, casebook) per card-writing rules. Write to `~/.hermes/legal-practice-profile/law-student/flashcards/[subject]/cards.md`.
...
- `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → current classes, weak subjects, existing outlines
- `~/.hermes/legal-practice-profile/law-student/flashcards/[subject]/cards.md` if it exists (incremental build)
...
- Load `~/.hermes/legal-practice-profile/law-student/study-plan.yaml` if it exists and read `session_history` for this subject.
...
- If no `study-plan.yaml`, write to `~/.hermes/legal-practice-profile/law-student/session-history.yaml` instead.

### `--generate` -- create cards

**Inputs:**
- Subject (class name or topic)
- Source (outline path, notes, or "use my existing outline from ~/.hermes/legal-practice-profile/law-student/CLAUDE.md")
