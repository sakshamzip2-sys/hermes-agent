---
title: "Product Legal Is This A Problem"
sidebar_label: "Product Legal Is This A Problem"
...
| Path | `skills/legal/product-legal/is-this-a-problem` |
...
1. Load `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` → Risk calibration.
...
Read `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` → `## Risk calibration`. The whole point of this skill is pattern-matching against that table.
...
Slack triage replies are internal legal advice. If the reply is being pasted into a ticket, document, or channel that's broadly shared with non-legal, prepend the work-product header from `~/.hermes/legal-practice-profile/product-legal/CLAUDE.md` `## Outputs` (it differs by user role -- see `## Who's using this`):
