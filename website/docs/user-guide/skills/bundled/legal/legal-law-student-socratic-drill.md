---
title: "Law Student Socratic Drill — Socratic drilling -- it asks, you answer, it pushes back"
sidebar_label: "Law Student Socratic Drill"
description: "Socratic drilling -- it asks, you answer, it pushes back"
---
...
| Path | `skills/legal/law-student/socratic-drill` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → learning style, classes, weak areas.
...
`~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → learning style (drill-me vs explain-to-me -- this skill is drill-me by design, but tone adjusts), weak areas, current classes.

## The drill

### Step 1: Pick the topic

User names it, or pull from weak areas in `~/.hermes/legal-practice-profile/law-student/CLAUDE.md`. If they keep avoiding a subject, that's the one to drill.
...
1. The student has actually uploaded materials (notes, outlines, case briefs, flashcards) referenced in `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → Seed materials, and
