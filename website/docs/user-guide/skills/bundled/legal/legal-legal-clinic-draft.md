---
title: "Legal Clinic Draft"
sidebar_label: "Legal Clinic Draft"
description: "First draft of a common clinic document -- practice-area templates (asylum applications, eviction answers, protective order petitions, demand letters), juris..."
---
...
| Path | `skills/legal/legal-clinic/draft` |
...
1. Load `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → practice-area templates, jurisdiction, local rules, supervision style.
...
`~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → practice areas, practice-area templates, jurisdiction (state + local court + any local rules ingested), supervision style.
...
Match the request to the clinic's template set (from `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md`). Common set by practice area:
...
Per `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` jurisdiction:
...
Filing a document with a court or agency is a consequential action. The gate is the supervision workflow in `## Supervision style` in `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md`, reinforced by the Part 0 role check that confirms a licensed supervising attorney owns the clinic setup. Court filings always route through supervision before filing, regardless of the supervision-style choice.
