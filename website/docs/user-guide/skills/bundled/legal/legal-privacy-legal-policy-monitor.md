---
title: "Privacy Legal Policy Monitor — Keep the privacy policy current with practice"
sidebar_label: "Privacy Legal Policy Monitor"
...
| Path | `skills/legal/privacy-legal/policy-monitor` |
...
1. Read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` → outputs folder path, policy document, last sweep date.
...
6. Update Last policy sweep date in `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md`.

**Direct query mode** (with description argument):
1. Read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` → current policy commitments + actual policy document.
...
Read `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md`:
...
Update **Last policy sweep** in `~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md` to today's date after completing the sweep.
...
`~/.hermes/legal-practice-profile/privacy-legal/CLAUDE.md`, so the next sweep only looks at new files.
