---
title: "Corporate Legal Material Contract Schedule"
sidebar_label: "Corporate Legal Material Contract Schedule"
description: "Build the material contracts disclosure schedule from diligence findings, applying the purchase agreement's Material Contract definition and formatting per t..."
---
...
| Path | `skills/legal/corporate-legal/material-contract-schedule` |
...
- `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` → materiality thresholds (may differ from the agreement definition -- use the agreement's)
