---
title: "Litigation Legal Deposition Prep"
sidebar_label: "Litigation Legal Deposition Prep"
description: "Build a deposition outline for a witness -- pull their documents from the eDiscovery platform, organize topics around the case theory, and surface impeachmen..."
---
...
| Path | `skills/legal/litigation-legal/deposition-prep` |
...
1. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → case theory, key facts.
...
`~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → case theory (theory, pivot fact, key facts for/against), eDiscovery platform.

**Conflicts gate -- unbypassable.** Before building an outline, check `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` for the matter slug. If the matter is not in `_log.yaml`, refuse and route:
...
- Facts from `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → key facts for us, that this witness can establish
