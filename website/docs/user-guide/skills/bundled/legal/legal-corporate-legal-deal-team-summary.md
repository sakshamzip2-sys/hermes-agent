---
title: "Corporate Legal Deal Team Summary"
sidebar_label: "Corporate Legal Deal Team Summary"
...
| Path | `skills/legal/corporate-legal/deal-team-summary` |
...
- `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` → Deal team briefing (cadence, format, what the business reads)
- `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/deal-context.md` → deal lead, timeline
- Current findings from diligence-issue-extraction output

## Audience tiers

Per `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` -- what the business reads vs. what's for the file. Default tiers:
...
If this is a recurring brief (per `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` cadence), lead with what changed:
