---
title: "Legal Clinic Memo — IRAC-scaffolded case analysis memo with research gaps flagged -- the scaffold, not the analysis"
sidebar_label: "Legal Clinic Memo"
description: "IRAC-scaffolded case analysis memo with research gaps flagged -- the scaffold, not the analysis"
---
...
| Path | `skills/legal/legal-clinic/memo` |
...
1. Load `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → practice areas, jurisdiction.
...
`~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → practice areas, jurisdiction, supervision style.
