---
title: "Litigation Legal Claim Chart"
sidebar_label: "Litigation Legal Claim Chart"
description: "Build or review an element chart -- a patent claim chart (infringement, invalidity, or review) or a civil element chart for any cause of action or defense --..."
---
...
| Path | `skills/legal/litigation-legal/claim-chart` |
...
1. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → role, work-product header, decision posture, document storage.
...
**Conflicts gate -- unbypassable.** Before building a claim chart, check `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` for the matter slug. If the matter is not in `_log.yaml`, refuse and route:
...
Prepend the work-product header from `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` `## Outputs`.
...
If matter workspaces enabled and a matter is active: `~/.hermes/legal-practice-profile/litigation-legal/matters/<matter-slug>/claim-charts/`. Otherwise: `~/.hermes/legal-practice-profile/litigation-legal/claim-charts/`. Surface the path. Append a one-line entry to the matter's `history.md`.
