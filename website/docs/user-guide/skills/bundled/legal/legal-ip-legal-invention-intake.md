---
title: "Ip Legal Invention Intake"
sidebar_label: "Ip Legal Invention Intake"
...
| Path | `skills/legal/ip-legal/invention-intake` |
...
`~/.hermes/legal-practice-profile/ip-legal/matters/<matter-slug>/`.
...
`~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`.** If it is
