---
title: "Employment Legal Worker Classification"
sidebar_label: "Employment Legal Worker Classification"
description: "Classify a proposed worker engagement -- employee, IC, temp, or vendor -- by running the applicable jurisdiction tests and flagging misclassification gaps be..."
---
...
| Path | `skills/legal/employment-legal/worker-classification` |
...
1. Load `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → jurisdictional footprint, escalation table.
...
Read `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → jurisdictional footprint, any classification history or
...
If `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` records the company's house classification policy, apply it
...
Escalate per `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` if any of the following, or any team-specific
...
**Before producing a "Proceed as IC / employee / agency / vendor" final recommendation:** Read `## Who's using this` in `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
