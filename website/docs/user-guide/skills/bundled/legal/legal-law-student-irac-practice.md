---
title: "Law Student Irac Practice"
sidebar_label: "Law Student Irac Practice"
description: "Grade an IRAC essay for structure, issue-spotting, rule accuracy, analysis depth, and organization"
---
...
| Path | `skills/legal/law-student/irac-practice` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → classes, exam formats, outline locations, learning style.
...
6. Append to `~/.hermes/legal-practice-profile/law-student/irac-sessions/[student]/tracker.md` for pattern detection. Surface patterns after 3+ sessions.
...
- `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → current classes, exam formats, outline locations, learning style
- `~/.hermes/legal-practice-profile/law-student/irac-sessions/[student]/tracker.md` if exists -- pattern tracking across sessions
...
Append to `~/.hermes/legal-practice-profile/law-student/irac-sessions/[student]/tracker.md`:
