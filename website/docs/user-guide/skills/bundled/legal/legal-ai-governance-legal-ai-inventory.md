---
title: "Ai Governance Legal Ai Inventory"
sidebar_label: "Ai Governance Legal Ai Inventory"
description: "EU AI Act per-system inventory -- track each AI system's role (provider, deployer, importer, distributor, authorized representative, product manufacturer) an..."
---
...
| Path | `skills/legal/ai-governance-legal/ai-inventory` |
...
1. **Read the config.** Read
   `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`.
...
2. **Read the inventory.** Inventory lives at
   `~/.hermes/legal-practice-profile/ai-governance-legal/ai-systems.yaml`.
