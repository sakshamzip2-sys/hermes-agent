---
title: "Legal Clinic Build Guide"
sidebar_label: "Legal Clinic Build Guide"
description: "Help a clinic supervisor author a practice-area guide that configures how student-facing skills behave -- intake questions, pedagogy posture (assist / guide ..."
---
...
| Path | `skills/legal/legal-clinic/build-guide` |
...
1. Load `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → role (must be Supervising attorney), practice areas, jurisdiction.
...
5. Write `~/.hermes/legal-practice-profile/legal-clinic/guides/<practice-area>.md`. Create the `guides/` directory if needed.
...
This is a supervisor skill. Read `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → `## Who's using this` → Role. If the role is not "Supervising attorney," say:
...
If a guide already exists at `~/.hermes/legal-practice-profile/legal-clinic/guides/<practice-area>.md`, offer: "A guide for [area] already exists at [path]. Do you want to (a) revise it section-by-section, (b) start fresh and overwrite, or (c) see what's there first?"
...
Write to `~/.hermes/legal-practice-profile/legal-clinic/guides/<practice-area>.md`. Create the `guides/` directory if it doesn't exist. Use this structure:
...
The skill's "output" is the file written at `~/.hermes/legal-practice-profile/legal-clinic/guides/<practice-area>.md`. The conversation with the supervisor is the interview; the written guide is the artifact.
