---
title: "Litigation Legal Subpoena Triage"
sidebar_label: "Litigation Legal Subpoena Triage"
description: "Triage a subpoena served on the company -- classify it, analyze scope/burden/privilege, cross-check the portfolio, and produce an objections framework, compl..."
---
...
| Path | `skills/legal/litigation-legal/subpoena-triage` |
...
3. If grand jury → stop, escalate per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. Otherwise continue.
4. Load `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` for cross-check. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → landscape, privilege conventions, escalation norms.
...
7. Write `~/.hermes/legal-practice-profile/litigation-legal/inbound/[slug]/triage.md`. Copy or link subpoena to `~/.hermes/legal-practice-profile/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` -- for related matter lookup and legal hold status
- `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → landscape (regulators we deal with), house privilege conventions, escalation norms
...
- Privilege log will be required -- flag the format per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`
...
Output: `~/.hermes/legal-practice-profile/litigation-legal/inbound/[slug]/triage.md`.
...
**Privilege log format required:** [per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`]
...
**Before responding to the subpoena (serving objections, producing documents, appearing for deposition, or filing a motion to quash -- any substantive response to the issuing party or court):** Read `## Who's using this` in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
- If classified as **grand jury subpoena** → stop, flag for escalation per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`, do not proceed with standard triage.
