---
title: "Corporate Legal Tabular Review"
sidebar_label: "Corporate Legal Tabular Review"
...
| Path | `skills/legal/corporate-legal/tabular-review` |
...
1. Load `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` → diligence structure, thresholds, house format.
...
- `~/.hermes/legal-practice-profile/corporate-legal/CLAUDE.md` → diligence structure, materiality thresholds, house format preferences
- `~/.hermes/legal-practice-profile/corporate-legal/deals/[code]/deal-context.md` if working a specific deal
