---
title: "Legal Clinic Client Intake"
sidebar_label: "Legal Clinic Client Intake"
description: "Structured intake -- practice-area templates, cross-area issue spotting, conflict flags, and triage classification"
---
...
| Path | `skills/legal/legal-clinic/client-intake` |
...
1. Load `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → practice areas, intake templates, supervision style, flag triggers.
...
Each practice area asks different questions. Use the template from `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` for this area. Defaults if none provided:
...
Per whatever conflict-check process `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` describes. At minimum:
...
Per `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` supervision style and flag triggers. If formal queue or configurable flags are enabled, and a trigger is present (deadline mentioned, DV indicator, immigration status at issue, etc.), note the flag.
