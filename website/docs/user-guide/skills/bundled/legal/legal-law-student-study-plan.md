---
title: "Law Student Study Plan"
sidebar_label: "Law Student Study Plan"
description: "Build or update a long-term bar prep (or exam prep) study plan -- phases, subjects weighted by weakness, daily session schedule, adaptive to session history ..."
---
...
| Path | `skills/legal/law-student/study-plan` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → bar jurisdiction, exam format, bar date, weak subjects, target study hours/day, prep course.
2. Load `~/.hermes/legal-practice-profile/law-student/study-plan.yaml` if it exists.
...
`~/.hermes/legal-practice-profile/law-student/CLAUDE.md`:
...
`~/.hermes/legal-practice-profile/law-student/study-plan.yaml` if it exists -- extend, don't overwrite.
...
Write to `~/.hermes/legal-practice-profile/law-student/study-plan.yaml`:
