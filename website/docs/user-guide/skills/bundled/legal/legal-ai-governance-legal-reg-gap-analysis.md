---
title: "Ai Governance Legal Reg Gap Analysis"
sidebar_label: "Ai Governance Legal Reg Gap Analysis"
...
| Path | `skills/legal/ai-governance-legal/reg-gap-analysis` |
...
1. Read `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`. Confirm regulatory footprint and use case registry are populated.
...
4. Extract requirements. Diff against current state in `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`.
...
(per `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` -- use case registry, vendor positions, impact assessment practices,
...
**We currently:** [what `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` / AI policy / use case registry / assessment
practice shows]
