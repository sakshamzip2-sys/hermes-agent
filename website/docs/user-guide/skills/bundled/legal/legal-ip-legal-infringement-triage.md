---
title: "Ip Legal Infringement Triage"
sidebar_label: "Ip Legal Infringement Triage"
...
| Path | `skills/legal/ip-legal/infringement-triage` |
...
Read `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`. Pull:
...
`~/.hermes/legal-practice-profile/ip-legal/matters/<matter-slug>/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.hermes/legal-practice-profile/ip-legal/outputs/infringe-<mode>-<subject-slug>-YYYY-MM-DD.md`
