---
title: "Employment Legal Handbook Updates"
sidebar_label: "Employment Legal Handbook Updates"
...
| Path | `skills/legal/employment-legal/handbook-updates` |
...
`~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → handbook location, state supplements list, update cadence.
...
For each state supplement in `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md`:
