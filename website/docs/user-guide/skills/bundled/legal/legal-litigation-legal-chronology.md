---
title: "Litigation Legal Chronology"
sidebar_label: "Litigation Legal Chronology"
...
| Path | `skills/legal/litigation-legal/chronology` |
...
1. Load `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` → theory, pivot fact, key facts.
2. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → Document storage sources, default matter folder pattern.
3. Follow the workflow and reference below.
4. Identify sources in order: user-provided paths this session, default matter folder, declared sources from `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`.
...
8. Write `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/chronology.md` (or format variant per flag).
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` → case theory, key facts, pivot fact (for significance tagging), key dates.
...
**Conflicts gate -- unbypassable (`--matter` mode).** Before building the chronology, check `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` for the matter slug. If the matter is not in `_log.yaml`, refuse and route:
...
Location: `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/chronology.md`. Complete, tagged, annotated. The reference doc counsel works from.
