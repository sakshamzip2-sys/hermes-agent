---
title: "Commercial Legal Stakeholder Summary"
sidebar_label: "Commercial Legal Stakeholder Summary"
...
| Path | `skills/legal/commercial-legal/stakeholder-summary` |
...
Read `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` → `## House style` → who reads stakeholder summaries, how long should they be. If not specified, default to: procurement or a department head, two paragraphs max, no legal terms of art.
...
**To the stakeholder:** Via whatever channel `~/.hermes/legal-practice-profile/commercial-legal/CLAUDE.md` says. If Slack, keep it under 150 words. If email, the format above is fine as-is.
