---
title: "Litigation Legal Demand Received"
sidebar_label: "Litigation Legal Demand Received"
description: "Triage an inbound demand letter -- extract fields, cross-check the portfolio, assess merit, present response options with a recommendation, and hand off to m..."
---
...
| Path | `skills/legal/litigation-legal/demand-received` |
...
2. Load `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` for portfolio cross-check.
3. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → risk calibration, landscape, demand-letter practice.
...
6. Write `~/.hermes/legal-practice-profile/litigation-legal/inbound/[slug]/triage.md`. Copy or link incoming to `~/.hermes/legal-practice-profile/litigation-legal/inbound/[slug]/incoming.[ext]`.
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` -- scan for related matters (same counterparty, overlapping counterparties via entity relationships, or matter type + recent date)
- `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → risk calibration (for merit assessment), landscape (is the sender a frequent adversary?), demand-letter practice (house tone and response defaults)
...
- **Leverage and pressure** -- are they credibly prepared to sue? Do they have capacity? Are they a repeat-litigant adversary per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`?
...
- Standalone → leave in `~/.hermes/legal-practice-profile/litigation-legal/inbound/`; no portfolio change.
