---
title: "Employment Legal Expansion Update"
sidebar_label: "Employment Legal Expansion Update"
description: "Update the status of an in-progress international expansion project -- recalculates what is now unblocked, flags anything overdue, and surfaces the next prio..."
---
...
| Path | `skills/legal/employment-legal/expansion-update` |
...
2. Identify the tracker file: `~/.hermes/legal-practice-profile/employment-legal/expansion-[slug].yaml`. If it doesn't
