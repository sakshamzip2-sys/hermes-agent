---
title: "Law Student Legal Writing"
sidebar_label: "Law Student Legal Writing"
description: "Structural feedback on a legal writing draft (memo, brief, paper, exam essay) -- organization, analysis depth, clarity, citation form"
---
...
| Path | `skills/legal/law-student/legal-writing` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → class, writing skill level, past feedback patterns.
...
7. Append to `~/.hermes/legal-practice-profile/law-student/writing-feedback/[student]/tracker.md` for pattern detection.
...
- `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → class, assignment type (if known), writing skill level, graded-essay feedback history
...
Append session summary to `~/.hermes/legal-practice-profile/law-student/writing-feedback/[student]/tracker.md`:
