---
title: "Legal Clinic Client Comms Log — Log a client communication -- call, email, text, letter, in-person, voicemail"
sidebar_label: "Legal Clinic Client Comms Log"
description: "Log a client communication -- call, email, text, letter, in-person, voicemail"
---
...
| Path | `skills/legal/legal-clinic/client-comms-log` |
...
3. Route by flag:
   - `--add` (default): capture direction, medium, student, summary, action items, follow-up due. Confirm with user. Append (prepend most-recent-first) to `~/.hermes/legal-practice-profile/legal-clinic/client-comms/[case-id]/log.md`.
...
- `~/.hermes/legal-practice-profile/legal-clinic/client-comms/[case-id]/log.md` (if exists) -- append target
- `~/.hermes/legal-practice-profile/legal-clinic/CLAUDE.md` → not heavily read; this skill is case-scoped
...
**Append** to `~/.hermes/legal-practice-profile/legal-clinic/client-comms/[case-id]/log.md`. If the log doesn't exist, create it with a header:
