---
title: "Employment Legal Internal Investigation"
sidebar_label: "Employment Legal Internal Investigation"
description: "Reference: shared framework for managing internal investigations from intake through final memo -- privileged investigation log, document processing with nee..."
---
...
| Path | `skills/legal/employment-legal/internal-investigation` |
...
Prepend the work-product header from `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → `## Outputs` (it differs by user role -- see `## Who's using this`). Every file, log, memo, and summary produced by this skill opens with that header.
...
Read `~/.hermes/legal-practice-profile/employment-legal/CLAUDE.md` → escalation table, any investigation protocols noted.
...
`~/.hermes/legal-practice-profile/employment-legal/investigation-[matter-slug]/log.yaml`:
...
`~/.hermes/legal-practice-profile/employment-legal/investigation-[matter-slug]/sources-checklist.yaml`:

Generated from the investigation type. See sources checklist templates below.

`~/.hermes/legal-practice-profile/employment-legal/investigation-[matter-slug]/documents-reviewed.yaml`:
...
`~/.hermes/legal-practice-profile/employment-legal/investigation-[slug]/sources-checklist.yaml`.
...
If multiple investigation folders exist in `~/.hermes/legal-practice-profile/employment-legal/`, ask which matter this
...
Write the draft to `~/.hermes/legal-practice-profile/employment-legal/investigation-[slug]/memo.md`.
