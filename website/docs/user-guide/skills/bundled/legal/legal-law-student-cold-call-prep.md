---
title: "Law Student Cold Call Prep"
sidebar_label: "Law Student Cold Call Prep"
description: "Prep for a cold-call -- predict the professor's likely questions and drill them Socratically, flagging where you're shaky so you know what to re-read before ..."
---
...
| Path | `skills/legal/law-student/cold-call-prep` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → class list, professors, learning style.
...
- `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → current classes, professors, learning style
...
- Professor (from ~/.hermes/legal-practice-profile/law-student/CLAUDE.md class list -- tone and focus vary by professor)
- Class / subject area
...
**Professor-specific flavor (from ~/.hermes/legal-practice-profile/law-student/CLAUDE.md notes):**
...
- **Predict jurisdiction-specific niche questions.** If the professor has known hobby horses, capture them in ~/.hermes/legal-practice-profile/law-student/CLAUDE.md class notes and the skill can weight accordingly; otherwise, it works from general patterns.
