---
title: "Ip Legal Portfolio — Track the IP portfolio -- registrations, renewals, maintenance fees, and use declarations"
sidebar_label: "Ip Legal Portfolio"
...
| Path | `skills/legal/ip-legal/portfolio` |
...
1. **Follow the workflow below** and read
   `~/.hermes/legal-practice-profile/ip-legal/portfolio.yaml`.
...
Lives at `~/.hermes/legal-practice-profile/ip-legal/portfolio.yaml`.
Structure:
...
Read `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`:
...
Output (prepend work-product header per `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md` → Outputs):
...
`## Who's using this` in `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
