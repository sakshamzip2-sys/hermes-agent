---
title: "Ai Governance Legal Policy Starter"
sidebar_label: "Ai Governance Legal Policy Starter"
description: "Draft a firm AI usage policy from published model policies, adapted to your practice profile -- a research-and-synthesis tool whose output is a draft for att..."
---
...
| Path | `skills/legal/ai-governance-legal/policy-starter` |
...
1. Read `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`. If the practice profile is unpopulated, stop and direct to `/ai-governance-legal:cold-start-interview`.
