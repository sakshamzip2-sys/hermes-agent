---
title: "Law Student Exam Forecast"
sidebar_label: "Law Student Exam Forecast"
description: "Analyze past exams from the same professor to surface patterns -- subject weighting, recurring issue-spot traps, favored hypo types, policy-vs-doctrine mix -..."
---
...
| Path | `skills/legal/law-student/exam-forecast` |
...
1. Load `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → class, professor, exam format, syllabus.
...
7. Write `~/.hermes/legal-practice-profile/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Framed as weighting heuristic, not prediction.
...
- `~/.hermes/legal-practice-profile/law-student/CLAUDE.md` → current classes, exam formats, syllabus if captured
...
Write to `~/.hermes/legal-practice-profile/law-student/exam-forecasts/[class]/forecast-[YYYY-MM-DD].md`. Versioned -- if the student gets another past exam mid-semester, re-run and append.
