---
title: "Ai Governance Legal Policy Monitor"
sidebar_label: "Ai Governance Legal Policy Monitor"
description: "Keep the AI policy current with practice -- weekly sweep of saved AIAs, triage results, and vendor reviews to find policy drift, or direct query for a propos..."
---
...
| Path | `skills/legal/ai-governance-legal/policy-monitor` |
...
1. Read `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` → outputs folder path, AI policy document, last sweep date.
...
6. Flag any use cases in outputs not yet added to the `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` registry.
7. Present results to the human. Only after acknowledgment, update `Last policy sweep` and `gaps_found` in `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`.

**Direct query mode** (with description argument):
1. Read `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` → current policy commitments, use case registry, actual policy document.
...
Read `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`:
...
→ **AI policy document**. The commitments in `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` are a summary; the actual
...
**Do not update `Last policy sweep` or `gaps_found` automatically.** After the sweep results are presented, wait for the human to acknowledge them ("sweep acknowledged," "results reviewed," or equivalent). Only then update `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`:
...
- Extract: vendor added, data use terms agreed to, any AI-specific provisions
  accepted that differ from standard positions in `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`
...
[Any use cases approved since the last sweep that aren't yet in the `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md`
...
[If this use case isn't in the registry: "Add to `~/.hermes/legal-practice-profile/ai-governance-legal/CLAUDE.md` → Use case registry:"]
```
