---
title: "Litigation Legal Legal Hold — Issue, refresh, release, or report on legal holds -- drafts the hold notice as"
sidebar_label: "Litigation Legal Legal Hold"
description: "Issue, refresh, release, or report on legal holds -- drafts the hold notice as"
---
...
| Path | `skills/legal/litigation-legal/legal-hold` |
...
2. Otherwise: load `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` + log row.
3. Load `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` → privilege markings, hold template pointer, escalation norms.
...
- `~/.hermes/legal-practice-profile/litigation-legal/matters/_log.yaml` -- log row (legal_hold fields + status)
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/matter.md` -- matter context (counterparty, facts, key custodians from internal_owners)
- `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` -- house style for litigation hold template pointer, privilege marking, escalation norms
...
**Before issuing the hold to custodians (the consequential act):** Read `## Who's using this` in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Draft the notice** to each custodian, using the house template in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` if one is configured; otherwise the default template below.
...
DATE: [effective date]
TO: [custodian name]
FROM: [signer -- per `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md` default]
...
**Writes:**
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/legal-hold-v1.docx` via the `docx` skill
- Appends to `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/history.md`:
  ```
...
**Writes:**
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/legal-hold-v[N].docx` (next version number)
- `history.md` entry
...
**Before releasing the hold (the consequential act -- preservation obligations resume normal retention):** Read `## Who's using this` in `~/.hermes/legal-practice-profile/litigation-legal/CLAUDE.md`. If the Role is Non-lawyer:
...
**Writes:**
- `~/.hermes/legal-practice-profile/litigation-legal/matters/[slug]/legal-hold-release.docx`
- `history.md` entry
