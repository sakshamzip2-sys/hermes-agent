---
title: "Ip Legal Clearance"
sidebar_label: "Ip Legal Clearance"
...
| Path | `skills/legal/ip-legal/clearance` |
...
1. Read `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`. If it
...
Before running clearance, read `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`. Pull:
...
If `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md` contains `[PLACEHOLDER]` or `[Your Company Name]`, surface this bounce:
...
Read `## Available integrations` from `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`:
...
Per the decision posture in `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md`:
...
Prepend the work-product header from `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md` `## Outputs`.
...
- [routing per `~/.hermes/legal-practice-profile/ip-legal/CLAUDE.md` --
...
`~/.hermes/legal-practice-profile/ip-legal/matters/<matter-slug>/outputs/clearance-<mark-slug>-YYYY-MM-DD.md`.
Otherwise write to
`~/.hermes/legal-practice-profile/ip-legal/outputs/clearance-<mark-slug>-YYYY-MM-DD.md`
