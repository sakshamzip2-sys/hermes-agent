...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to OpenComputer — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in OpenComputer tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying OpenComputer core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a OpenComputer Plugin](/guides/build-a-opencomputer-plugin)
...
- [ ] Tested with `opencomputer chat -q "Use the weather tool for London"`
