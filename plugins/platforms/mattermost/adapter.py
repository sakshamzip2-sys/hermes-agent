...
required — uses aiohttp which is already a OpenComputer dependency.
...
def interactive_setup() -> None:
    ...
    print()
    print_info("📬 Home Channel: where OpenComputer delivers cron job results and notifications.")
