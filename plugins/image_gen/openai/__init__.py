...
three virtual model IDs so the ``oc tools`` model picker and the
...
class OpenAIImageGenProvider(ImageGenProvider):
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        # Preserve OC-router routing: construct the client with the configured
        # base_url (the OpenComputer standing rule routes image gen through
        # OC-router, not the default OpenAI endpoint). Upstream's bare
        # openai.OpenAI() would bypass it.
        client = (
