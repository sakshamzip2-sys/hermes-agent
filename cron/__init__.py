"""
Cron job scheduling system for OpenComputer.
...
Cron jobs are executed automatically by the gateway daemon:
    oc gateway install    # Install as a user service
    sudo oc gateway install --system  # Linux servers: boot-time system service
    oc gateway            # Or run in foreground
