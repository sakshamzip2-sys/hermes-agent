...
Trust levels:
  - builtin:   Ships with OpenComputer. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references OpenComputer secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references OpenComputer configuration files directly"),
...
# scan. `.skillignore` is the OpenComputer-native name; `.clawhubignore` is honored
