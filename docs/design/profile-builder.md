...
Supersedes: PR #31781 (prompt_toolkit `opencomputer profile wizard`)

## Why this, not the CLI wizard

PR #31781 added a keyboard-driven `opencomputer profile wizard` in the terminal.
...
5. spawn `opencomputer -p <profile> skills install <id>` per hub skill (async, returns PIDs)
