...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateOpenComputer: "OpenComputer'i Güncelle",
    updatingOpenComputer: "OpenComputer güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "OpenComputer eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`opencomputer plugins` ile eşdeğer).",
