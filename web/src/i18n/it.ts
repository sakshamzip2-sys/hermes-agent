...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateOpenComputer: "Aggiorna OpenComputer",
    updatingOpenComputer: "Aggiornamento di OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin OpenComputer (parità con `opencomputer plugins`).",
