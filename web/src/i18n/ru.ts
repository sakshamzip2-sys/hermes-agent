...
export const ru: Translations = {
  ...
  status: {
    ...
    stopped: "Остановлено",
    updateOpenComputer: "Обновить OpenComputer",
    updatingOpenComputer: "Обновление OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Поиск, установка, включение и обновление плагинов OpenComputer (аналог `opencomputer plugins`).",
