...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateOpenComputer: "Werk OpenComputer op",
    updatingOpenComputer: "Besig om OpenComputer op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk OpenComputer-inproppe op (`opencomputer plugins` ekwivalent).",
