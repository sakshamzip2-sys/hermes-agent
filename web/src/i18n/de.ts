...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateOpenComputer: "OpenComputer aktualisieren",
    updatingOpenComputer: "OpenComputer wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "OpenComputer-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `opencomputer plugins`).",
