...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateOpenComputer: "Atualizar OpenComputer",
    updatingOpenComputer: "A atualizar OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins OpenComputer (paridade com `opencomputer plugins`).",
