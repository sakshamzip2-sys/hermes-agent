...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateOpenComputer: "Actualizar OpenComputer",
    updatingOpenComputer: "Actualizando OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de OpenComputer (equivalente a `opencomputer plugins`).",
