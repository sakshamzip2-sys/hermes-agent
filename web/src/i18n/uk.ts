...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateOpenComputer: "Оновити OpenComputer",
    updatingOpenComputer: "Оновлення OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни OpenComputer (паритет з `opencomputer plugins`).",
