...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateOpenComputer: "Nuashonraigh OpenComputer",
    updatingOpenComputer: "Ag nuashonrú OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins OpenComputer (paireacht le `opencomputer plugins`).",
