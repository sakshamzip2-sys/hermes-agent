...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateOpenComputer: "OpenComputer frissítése",
    updatingOpenComputer: "OpenComputer frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "OpenComputer-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `opencomputer plugins` paritás).",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a OpenComputert",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in OpenComputer ☤",
    },
  },
  kanban: {
