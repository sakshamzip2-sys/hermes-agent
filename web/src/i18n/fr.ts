...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateOpenComputer: "Mettre à jour OpenComputer",
    updatingOpenComputer: "Mise à jour de OpenComputer…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins OpenComputer (parité avec `opencomputer plugins`).",
