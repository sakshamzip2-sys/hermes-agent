...
This is an additive OpenComputer extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal OpenComputer head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal OpenComputer DB session id
