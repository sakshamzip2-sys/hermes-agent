...
test('desktop backend PATH adds OpenComputer-managed bins and missing POSIX sane entries', () => {
...
test('normalizeHermesHomeRoot maps profile homes back to the global OpenComputer root', () => {
  assert.equal(
