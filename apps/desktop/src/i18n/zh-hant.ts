...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'OpenComputer Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 OpenComputer 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      remoteUrlDesc: '遠端儀表板後端的基礎 URL。支援路徑前綴，例如 /opencomputer。',
    ...
    providers: {
      ...
      removeExternal: (provider, command) => `${provider} 由 OpenComputer 外部管理。請使用 ${command} 移除。`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 使用者 ID', placeholder: '@opencomputer:example.org' },
  ...
  updates: {
    ...
    applyingBody: 'OpenComputer 更新程式會在自己的視窗中接管，並在完成後重新開啟 OpenComputer。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 OpenComputer 會自動重新連線。',
    applyingClose: 'OpenComputer 將關閉以套用更新。',
    errorTitle: '更新未完成',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: '開啟瀏覽器登入 — OpenComputer 會自動連線',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayOffline: '離線',
      gatewayTitle: 'OpenComputer 推論閘道狀態',
      agents: '代理',
      closeAgents: '關閉代理',
      openAgents: '開啟代理',
      subagents: count => `${count} 個子代理`,
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: '等待閘道逾時。`opencomputer gateway` 是否正在執行？'
    }
  },
