...
/** Why a known OpenComputer command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/version', description: 'Show OpenComputer version', surface: exec() },
 ...
 * OpenComputer' built-in slash commands — i.e. skill commands (`/gif-search`,
