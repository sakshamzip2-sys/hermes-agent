...
const PLATFORM_INTRO: Record<string, string> = {
  ...
  weixin:
    'Run `oc gateway setup`, select Weixin, then scan and confirm the QR code with a personal WeChat account. OpenComputer connects through Tencent\'s iLink Bot API and saves the credentials.',
