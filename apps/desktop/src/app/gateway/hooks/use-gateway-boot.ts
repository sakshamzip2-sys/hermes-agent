...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting OpenComputer...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting OpenComputer…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to OpenComputer gateway". resolveGatewayWsUrl
