...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/opencomputer-typing
# → /tmp/opencomputer-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/opencomputer-typing.before.heapsnapshot
# → /tmp/opencomputer-typing.after.heapsnapshot
```
