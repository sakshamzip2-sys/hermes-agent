...
/// desktop app handing off via `OpenComputer-Setup.exe --update`.
  ...
  unlisten = await listen<BootstrapEvent>('bootstrap', (event) => {
    ...
    switch (payload.type) {
      ...
      case 'complete':
        ...
        // Install: show the "launch OpenComputer" success screen. Update: this is a
...
export async function startUpdate(): Promise<void> {
  // Update is driven by the desktop handing off (OpenComputer-Setup.exe --update);
