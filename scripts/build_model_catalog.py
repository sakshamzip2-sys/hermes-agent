#!/usr/bin/env python3
"""Build the OpenComputer Model Catalog — a centralized JSON manifest of curated models.
...
OpenComputer CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a OpenComputer release.
