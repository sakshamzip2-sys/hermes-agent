"""Coding-context awareness — base OpenComputer, every interactive surface.

When the user runs OpenComputer inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), OpenComputer shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether OpenComputer should operate in its coding posture right now."""
