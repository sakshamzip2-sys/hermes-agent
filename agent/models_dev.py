...
# ---------------------------------------------------------------------------
# Provider ID mapping: OpenComputer ↔ models.dev
# ---------------------------------------------------------------------------

# OpenComputer provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → OpenComputer (built lazily)
...
def fetch_models_dev(force_refresh: bool = False) -> Dict[str, Any]:
    ...
    When ``force_refresh=True`` (used by ``oc config refresh``, the
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a OpenComputer provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal OpenComputer traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a OpenComputer provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve OpenComputer ID → models.dev ID
...
def get_model_info(
    ...
    Accepts OpenComputer or models.dev provider ID.  Tries exact match then
