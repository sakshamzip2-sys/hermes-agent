...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. OpenComputer-created private-chat topic lanes are marked with
    ...
    # older PTB/clients. Streaming edits stay on OpenComputer' existing MarkdownV2
    ...
    def _has_telegram_desktop_details_math_crash_shape(self, content: str) -> bool:
        ...
        OpenComputer must skip rich delivery up front and use the legacy MarkdownV2
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        # has been killed (e.g. during `oc update` or `--replace` handoffs)
        ...
        message = (
            ...
            "To recover: ensure no other OpenComputer or OpenClaw instance is running "
            "with this token, then restart the gateway with 'oc gateway restart'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the OpenComputer process (shared mount, same machine, etc.).
    ...
    def _build_provider_keyboard(self, providers: list):
        ...
        CLI ``oc model`` picker via the shared ``group_providers`` fold,
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several OpenComputer bot profiles. A message like
