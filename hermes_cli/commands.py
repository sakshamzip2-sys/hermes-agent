...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("agents", "Show active agents and running tasks", "Session",
               aliases=("tasks",)),
    CommandDef("agent", "Chat as a specialized agent (finance, legal, deep-research, ...)",
               "Session", gateway_only=True, args_hint="[<name>|list|off]",
               subcommands=("list", "off")),
    ...
    CommandDef("yolo", "Toggle YOLO mode (skip all dangerous command approvals)",
               "Configuration"),
    CommandDef("plan", "Enter plan mode — investigate & propose only; mutations blocked",
               "Configuration"),
    CommandDef("accept-edits", "Leave plan mode — restore write/patch & state changes",
               "Configuration", aliases=("accept_edits", "acceptedits")),
    CommandDef("permissions", "Show, test, or set declarative permission rules + mode",
               "Configuration", args_hint="[mode <normal|plan|yolo>|test <Tool> <target>]",
               subcommands=("mode", "test")),
