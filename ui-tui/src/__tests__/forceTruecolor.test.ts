...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless OpenComputer truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit OpenComputer truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
