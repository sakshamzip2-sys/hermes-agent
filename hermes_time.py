"""
Timezone-aware clock for OpenComputer.
...
Invalid timezone values log a warning and fall back safely — OpenComputer never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — OpenComputer requires 3.9+)
