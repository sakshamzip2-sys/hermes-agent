...
def test_cli_unpin_refuses_bundled_skill(curator_env, capsys):
    """oc curator unpin must refuse bundled/hub skills too (matches pin)."""
...
# `oc model` → auxiliary picker, the dashboard Models tab, and the full
