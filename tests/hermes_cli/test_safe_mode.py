"""Tests for `oc chat --safe-mode` — pristine troubleshooting runs.
...
troubleshooting. The OpenComputer equivalent:
...
class TestSafeModeParser:
    """--safe-mode must parse on both the root parser and `oc chat`."""
