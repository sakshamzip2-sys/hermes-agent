"""Tests for the ``oc hooks`` CLI subcommand."""
...
class TestHooksDoctor:
    ...
    def test_unallowlisted_script_is_not_executed(self, tmp_path):
        """Regression for M4: `oc hooks doctor` used to run every
