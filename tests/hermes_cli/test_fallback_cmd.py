"""Tests for `oc fallback` — chain reading, add/remove/clear, legacy migration."""
...
class TestArgparseWiring:
    """Verify `oc fallback` is wired into main.py's argparse tree.
